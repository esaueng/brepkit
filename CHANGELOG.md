...
## [3.0.0](https://github.com/esaueng/brepkit/compare/v2.130.0...v3.0.0) (2026-08-15)
...
* add multi-root arena serialization ([4b3615c](https://github.com/esaueng/brepkit/commit/4b3615c3b49ca2cf25c9a4592f81241488d5eb25))
* add multi-root arena serialization v2 ([8363275](https://github.com/esaueng/brepkit/commit/83632750a9479b6a558eb51e01577891dc9a4ef3))
* add per-solid retirement ([4dbebbe](https://github.com/esaueng/brepkit/commit/4dbebbe77262fe18a69bd7c25fb8928eb802adf3))
* add scoped batch operation parity ([c47aa96](https://github.com/esaueng/brepkit/commit/c47aa9604bdda3835d66d8b95e54106e2ea93398))
* **blend:** chamfer closed circular rims ([#27](https://github.com/esaueng/brepkit/issues/27)) ([c54c4d6](https://github.com/esaueng/brepkit/commit/c54c4d694f3b3a85235e6375910c07ed9b0fd1d1))
* **blend:** fillet drilled plates — corner chains, perimeters, and hole rims ([#38](https://github.com/esaueng/brepkit/issues/38)) ([076b4e6](https://github.com/esaueng/brepkit/commit/076b4e63a667cfbfada62b2d2681d56e8464c1bf))
* **blend:** follow G1 ridgelines when filleting, not just the named edges ([#23](https://github.com/esaueng/brepkit/issues/23)) ([df3fe7b](https://github.com/esaueng/brepkit/commit/df3fe7b0b8ab398fa728722a45bcac35398a9a63))
* harden fillet and chamfer evolution ([ccc7b64](https://github.com/esaueng/brepkit/commit/ccc7b64ed1fee037958b0b3112e842f58c6896ef))
* harden fillet and chamfer evolution ([d165628](https://github.com/esaueng/brepkit/commit/d16562808f1250b46dba4eb9afbc37a8d30cfaa1))
* **io:** STEP import/export fidelity — surface curves, units, voids, swept surfaces ([#37](https://github.com/esaueng/brepkit/issues/37)) ([c432d09](https://github.com/esaueng/brepkit/commit/c432d09ee9353879ae60862233622b71afac0d95))
* N-way GFA fuse — 3.9x faster kumiko compound_cut ([#1202](https://github.com/esaueng/brepkit/issues/1202)) ([59f7910](https://github.com/esaueng/brepkit/commit/59f7910c9e6d7beaf29dd8a8102c2bb2a2156069))
* **operations:** expose shell orientation consistency in solid validation ([#1365](https://github.com/esaueng/brepkit/issues/1365)) ([74ded6b](https://github.com/esaueng/brepkit/commit/74ded6b0e05bceffcf2509872e30ea1aa733f5de))
* **operations:** native push/pull and cylindrical-face resize ([#18](https://github.com/esaueng/brepkit/issues/18)) ([725ec7c](https://github.com/esaueng/brepkit/commit/725ec7c93b709299252bf1a2affc6d5c0b6415c7))
* **operations:** union robustness census example ([7b02983](https://github.com/esaueng/brepkit/commit/7b029830ac77227e539430f054ab244bda02ce2a))
* **operations:** union robustness census example ([7e97344](https://github.com/esaueng/brepkit/commit/7e9734451f31b7b45a95c4ae46369e46225c565e))
* preserve rational STEP geometry ([7ad8d54](https://github.com/esaueng/brepkit/commit/7ad8d545ff2969563f682da39e7396ae3379a059))
* replay Apache-compatible fork contributions ([#253](https://github.com/esaueng/brepkit/issues/253)) ([69bf53a](https://github.com/esaueng/brepkit/commit/69bf53a1584c76ccdc796d22283624bb0be8568c))
* **sketch:** add five GCS constraints and truthful solve diagnostics ([7916966](https://github.com/esaueng/brepkit/commit/7916966f0002aa5643a762fc5923c7b4f730f475))
* **step:** preserve rational STEP geometry exactly ([a982b97](https://github.com/esaueng/brepkit/commit/a982b97f88f52d6ce4cd8742290affbe7874d80e))
* **wasm:** 2D polygon booleans, validated hole wires, makeFaceFromWires ([#63](https://github.com/esaueng/brepkit/issues/63)) ([bb15475](https://github.com/esaueng/brepkit/commit/bb15475aeff2feb3eb836283cbd5c4332308d4f0))
* **wasm:** add stable batch error codes ([3e82c9d](https://github.com/esaueng/brepkit/commit/3e82c9d13c8867f88b419ed823ca036b9e05ba82))
* **wasm:** add stable batch error codes ([dbac094](https://github.com/esaueng/brepkit/commit/dbac094e6eb0745ab286b2552c0a5cce75d7588e))
* **wasm:** add structured validation diagnostics ([64c4bea](https://github.com/esaueng/brepkit/commit/64c4bea141d5041bc36d79d722b2c8d162b08ced))
* **wasm:** configurable healing — per-fix config and custom pipelines ([#5](https://github.com/esaueng/brepkit/issues/5)) ([acc37d3](https://github.com/esaueng/brepkit/commit/acc37d31280e5d5ae08ed0073d662a4ac7968a0c))
* **wasm:** default fillet engine order flips to v2-first ([#10](https://github.com/esaueng/brepkit/issues/10)) ([ad434a6](https://github.com/esaueng/brepkit/commit/ad434a6262565188b0a00188461b0c414f092b8d))
* **wasm:** export several solids into one STEP file ([#36](https://github.com/esaueng/brepkit/issues/36)) ([f432c28](https://github.com/esaueng/brepkit/commit/f432c286f7abd95899802bf1aa1505a6b5a4fb36))
* **wasm:** expose mass properties, mesh quality, boolean options, and bounded imports ([#3](https://github.com/esaueng/brepkit/issues/3)) ([3bf81ef](https://github.com/esaueng/brepkit/commit/3bf81efdd1ebe2ab4d690106a5783f0792d1ca05))
* **wasm:** report typed fillet errors instead of the silent no-op ([#35](https://github.com/esaueng/brepkit/issues/35)) ([6f271fa](https://github.com/esaueng/brepkit/commit/6f271fa9fc2b580c74d231c43be2a01e6260153f))
* **wasm:** typed GCS sketch bindings with the full 19-constraint surface ([#4](https://github.com/esaueng/brepkit/issues/4)) ([bd7bce7](https://github.com/esaueng/brepkit/commit/bd7bce75b8c264f9945932a2803fdadf927b15c8))


### Bug Fixes

* **algo,operations:** clear the boundary in 2D interior sampling; miter a swallowed corner fillet ([1449fe2](https://github.com/esaueng/brepkit/commit/1449fe27bc0f7ab62c93e3b0a5d4d3c13c25f0ec))
* **algo:** analytic torus arm for the ray-cast classifier ([#1300](https://github.com/esaueng/brepkit/issues/1300)) ([cc0ad02](https://github.com/esaueng/brepkit/commit/cc0ad02aa672c02649d348b05b10a3dbadc8f74e))
* **algo:** arc-true hole-promotion containment on plane faces ([#1156](https://github.com/esaueng/brepkit/issues/1156)) ([70554b3](https://github.com/esaueng/brepkit/commit/70554b38cb68fa1afd827705587e72911866ca5e))
* **algo:** assemble the label-tab attach fuse analytically ([#1194](https://github.com/esaueng/brepkit/issues/1194)) ([b9aacff](https://github.com/esaueng/brepkit/commit/b9aacffb4d686da1ccd9e1da1794b7175c15a8b3))
* **algo:** band-split a lateral drilled clean through ([#115](https://github.com/esaueng/brepkit/issues/115)) ([25b7aed](https://github.com/esaueng/brepkit/commit/25b7aede8d42c7da52bc40cc230fb77729cb1d0e))
* **algo:** canonical same-domain key for closed edges ([#21](https://github.com/esaueng/brepkit/issues/21)) ([0d20005](https://github.com/esaueng/brepkit/commit/0d20005a7d4c56a7c075d3f752d64c987ff17409))
* **algo:** classify thin coincident-band ring by absolute-nudge probe ([#1209](https://github.com/esaueng/brepkit/issues/1209)) ([e664ee7](https://github.com/esaueng/brepkit/commit/e664ee710689d6569dd1809b0b38fb07f959e6cd))
* **algo:** clip sections to true NURBS boundary arcs, perf-safe ([#1343](https://github.com/esaueng/brepkit/issues/1343)) ([fa292b0](https://github.com/esaueng/brepkit/commit/fa292b0ba1e52cd2e200bdf5df6325e32419d790))
* **algo:** clip straight FF sections to the mutual AABB exactly ([#1224](https://github.com/esaueng/brepkit/issues/1224)) ([7ce54c7](https://github.com/esaueng/brepkit/commit/7ce54c78c8093c9884f8233346eba6deffc2f1c7))
* **algo:** close the 2-tangency quadric-box fuse (parallel half-arc sections) ([#1257](https://github.com/esaueng/brepkit/issues/1257)) ([15e31a2](https://github.com/esaueng/brepkit/commit/15e31a251c9d3ff91b3d5f538a1cd7df08886b77))
* **algo:** close the 2-tangency quadric-box fuse (parallel half-arc sections) ([#1257](https://github.com/esaueng/brepkit/issues/1257)) ([2f64f78](https://github.com/esaueng/brepkit/commit/2f64f780b04735465f4b162fc30384f00be2e5e3))
* **algo:** close the circle-outside cone∪box fuse (winding-chain band splitting) ([#1259](https://github.com/esaueng/brepkit/issues/1259)) ([659ef7a](https://github.com/esaueng/brepkit/commit/659ef7a7d3a4ad992e390d42956bb0d1de56feba))
* **algo:** close the circle-outside cone∪box fuse (winding-chain band splitting) ([#1259](https://github.com/esaueng/brepkit/issues/1259)) ([5d5e85b](https://github.com/esaueng/brepkit/commit/5d5e85b798cdacf11d0467178db04b8c1d252b1a))
* **algo:** close the kumiko lattice band fuse ([#1302](https://github.com/esaueng/brepkit/issues/1302)) ([ff91120](https://github.com/esaueng/brepkit/commit/ff91120142e257017af5e2aa2df592eb3889f451))
* **algo:** close the quadric-box inscribed-rim fuse (4-tangency cone/cylinder ∪ box) ([#1254](https://github.com/esaueng/brepkit/issues/1254)) ([a5fac3a](https://github.com/esaueng/brepkit/commit/a5fac3aed0acb110a766130778c1bdc41966c276))
* **algo:** close the quadric-box inscribed-rim fuse (4-tangency cone/cylinder ∪ box) ([#1254](https://github.com/esaueng/brepkit/issues/1254)) ([449f5f0](https://github.com/esaueng/brepkit/commit/449f5f0a6312e972dda41a708627ed9bf0e6a00b))
* **algo:** drop boundary-collinear line sections on plane faces ([#1174](https://github.com/esaueng/brepkit/issues/1174)) ([78ac694](https://github.com/esaueng/brepkit/commit/78ac694f16493f82c62d43a1e6dd745758b763d2))
* **algo:** drop tangency-graze section circles riding the plane-extent margin band ([#102](https://github.com/esaueng/brepkit/issues/102)) ([d506437](https://github.com/esaueng/brepkit/commit/d506437b5e6b996b68a3a8053e2f0e686760b904))
* **algo:** emit ellipse section arcs in sub-π spans ([#1262](https://github.com/esaueng/brepkit/issues/1262)) ([48f6213](https://github.com/esaueng/brepkit/commit/48f6213b62ff8f252ad7a7476523be9974d3c58f))
* **algo:** emit ellipse section arcs in sub-π spans ([#1262](https://github.com/esaueng/brepkit/issues/1262)) ([cc817c0](https://github.com/esaueng/brepkit/commit/cc817c0e2f058e3450c169e1872b5ddb9cd28b9d))
* **algo:** exact polygon clip for plane-plane lines in the FF prefilter ([#1267](https://github.com/esaueng/brepkit/issues/1267)) ([98300e5](https://github.com/esaueng/brepkit/commit/98300e52173fee0eb3055dc319d5b20f4114fd25))
* **algo:** exact polygon clip for plane-plane lines in the FF prefilter ([#1267](https://github.com/esaueng/brepkit/issues/1267)) ([e6f97b5](https://github.com/esaueng/brepkit/commit/e6f97b568d66eb029af7216e7cc021b3ecffa5bc))
* **algo:** excise out-and-back spurs and slit faces before assembly ([#1187](https://github.com/esaueng/brepkit/issues/1187)) ([e5f234a](https://github.com/esaueng/brepkit/commit/e5f234a883d7059af5b988b90f22c3858ebb8a8a))
* **algo:** expand NURBS boundary images so coaxial revolve cuts split ([#1352](https://github.com/esaueng/brepkit/issues/1352)) ([f17d409](https://github.com/esaueng/brepkit/commit/f17d4097932a2df269bc0a6b169d87e0292a3775))
* **algo:** gate EF-IN pave blocks on surface deviation vs chord ([#1168](https://github.com/esaueng/brepkit/issues/1168)) ([685c618](https://github.com/esaueng/brepkit/commit/685c6184adafceae1d4c5d09572651e8e8d5fc7f))
* **algo:** keep chord crossings at a closed rim's seam angle ([#1176](https://github.com/esaueng/brepkit/issues/1176)) ([3bb362d](https://github.com/esaueng/brepkit/commit/3bb362d9d43e6bc10caaeec6eba060283a0b668f))
* **algo:** keep exact operand geometry through arrangement emission and welds ([#1277](https://github.com/esaueng/brepkit/issues/1277)) ([67de3ab](https://github.com/esaueng/brepkit/commit/67de3ab5047b5134a7e2e8d99f0d25a6707fa668))
* **algo:** keep exact operand geometry through arrangement emission and welds ([#1277](https://github.com/esaueng/brepkit/issues/1277)) ([2867851](https://github.com/esaueng/brepkit/commit/28678511353c456c661792e0af9a0d4625540ab9))
* **algo:** keep the protruding cap crescent when a cylinder fuses past a box corner ([#116](https://github.com/esaueng/brepkit/issues/116)) ([80c90bb](https://github.com/esaueng/brepkit/commit/80c90bb5fc8038ea9c226a670d64f67d7c77c826))
* **algo:** line splits return the foot; pin the weld-band contract ([#1272](https://github.com/esaueng/brepkit/issues/1272)) ([352aa60](https://github.com/esaueng/brepkit/commit/352aa60d7b45fbfcc996bf90727ce085821b198d))
* **algo:** line splits return the foot; pin the weld-band contract ([#1272](https://github.com/esaueng/brepkit/issues/1272)) ([4aaf28d](https://github.com/esaueng/brepkit/commit/4aaf28de94d4dcd85a3b74197ebcb21059bf3ac8))
* **algo:** never attach a hole to its own reversed-twin outline ([#1185](https://github.com/esaueng/brepkit/issues/1185)) ([67f5023](https://github.com/esaueng/brepkit/commit/67f50230a66a4867b8662a90d9dd26520e6a4326))
* **algo:** prefer deeper interior samples on plane faces ([#1189](https://github.com/esaueng/brepkit/issues/1189)) ([c69113d](https://github.com/esaueng/brepkit/commit/c69113dbb50b486191013a4516870213c24efd13))
* **algo:** re-cast grazed cardinal rays when clean rays unanimously disagree ([#1357](https://github.com/esaueng/brepkit/issues/1357)) ([0667d9b](https://github.com/esaueng/brepkit/commit/0667d9bf4dbcf5a4d562f9d141b93006c5a33d63))
* **algo:** refine closed circle rims at mate-partition vertices in assembly ([#1166](https://github.com/esaueng/brepkit/issues/1166)) ([8544a08](https://github.com/esaueng/brepkit/commit/8544a0803d7ce7cb90d585854c668c9f82d2c9e4))
* **algo:** respect face holes in the EF containment test ([#25](https://github.com/esaueng/brepkit/issues/25)) ([437677e](https://github.com/esaueng/brepkit/commit/437677eb964e21361f96e543dbd982c3aed676fb))
* **algo:** SD midpoint discriminator + sector rescue for under-split periodic strips ([#1178](https://github.com/esaueng/brepkit/issues/1178)) ([b04da2a](https://github.com/esaueng/brepkit/commit/b04da2a3f8aaa14874639e646b2a8533d35467b2))
* **algo:** skip point-tangency sections instead of aborting the boolean ([#1172](https://github.com/esaueng/brepkit/issues/1172)) ([6ea3a1c](https://github.com/esaueng/brepkit/commit/6ea3a1c9de3b5fa7b8278a3e6e975f9410186213))
* **algo:** split ellipse sections with the shorter-arc convention on both twins ([#1150](https://github.com/esaueng/brepkit/issues/1150)) ([06008ea](https://github.com/esaueng/brepkit/commit/06008eac90d7eb41cdb2f995aaf7a3862c00cb26))
* **algo:** split plane faces carrying several closed section loops ([#24](https://github.com/esaueng/brepkit/issues/24)) ([e9c9080](https://github.com/esaueng/brepkit/commit/e9c90806cd53c454978a3cf765ed06ad57954eeb))
* **algo:** trace full-period cylinder partitions with the seam-glued DCEL ([#1152](https://github.com/esaueng/brepkit/issues/1152)) ([75c95a4](https://github.com/esaueng/brepkit/commit/75c95a41d55fbad40d51fa1220df978d561df415))
* **algo:** trim closed-section windows against the margin-free face window ([#1148](https://github.com/esaueng/brepkit/issues/1148)) ([98c1540](https://github.com/esaueng/brepkit/commit/98c1540ece6141b2bf680f546ba74ad18236d2c9))
* **algo:** unify cross-solver junction anchors in the kumiko lattice fuse ([#1284](https://github.com/esaueng/brepkit/issues/1284)) ([40afb47](https://github.com/esaueng/brepkit/commit/40afb4770dcee5e5dd979200581300cea69cad47))
* **algo:** unify cross-solver junction anchors in the kumiko lattice fuse ([#1284](https://github.com/esaueng/brepkit/issues/1284)) ([ec70f68](https://github.com/esaueng/brepkit/commit/ec70f68b9db54cd5a181cb39d7b7b489a5cc2b9c))
* **algo:** unwrap periodic wire UV per edge, not across the whole loop ([#106](https://github.com/esaueng/brepkit/issues/106)) ([be76895](https://github.com/esaueng/brepkit/commit/be76895aa57856529ae28bc2b298279935f4a3b9))
* **algo:** veto line sections that only graze a plane face's rim ([9146625](https://github.com/esaueng/brepkit/commit/914662524490ba8924777fee77e3be865e5a9d8f))
* **algo:** veto line sections that only graze a plane face's rim ([abd3d2e](https://github.com/esaueng/brepkit/commit/abd3d2ed7ce9addbedc8d5db2ae3adf77e424ed0))
* **algo:** weld-scale boundary anchoring for line splits ([#1270](https://github.com/esaueng/brepkit/issues/1270)) ([8fdd7a5](https://github.com/esaueng/brepkit/commit/8fdd7a5369e9043e91d3b031c145aca3bfb9406f))
* **algo:** weld-scale boundary anchoring for line splits ([#1270](https://github.com/esaueng/brepkit/issues/1270)) ([d20e2e3](https://github.com/esaueng/brepkit/commit/d20e2e36e3c3412528b123a23e24e6bd4a1f5b23))
* **algo:** within-rank SD dedup must not drop a cross-shell coincident face ([#1360](https://github.com/esaueng/brepkit/issues/1360)) ([8f98761](https://github.com/esaueng/brepkit/commit/8f98761471ac0e4af4adfbd7e3ce8ecc6426800b))
* **blend:** a bore rim in the selection refused a corner it never touched ([#47](https://github.com/esaueng/brepkit/issues/47)) ([ba6a850](https://github.com/esaueng/brepkit/commit/ba6a850b7fddc7fa087d4f9baa54394a04874bbb))
* **blend:** a cap rim refused every radius past half, and seamed its wall across the axis ([#50](https://github.com/esaueng/brepkit/issues/50)) ([1728515](https://github.com/esaueng/brepkit/commit/172851524318a95d64e80901cde993506b928efd))
* **blend:** chamfer a bore mouth, and mesh the band it leaves ([#29](https://github.com/esaueng/brepkit/issues/29)) ([75d378a](https://github.com/esaueng/brepkit/commit/75d378ae35ac5a8bd4097150e30cda8857d68040))
* **blend:** exact tangent-ball vertex blends, fence unsupported corners ([#34](https://github.com/esaueng/brepkit/issues/34)) ([bdba0ab](https://github.com/esaueng/brepkit/commit/bdba0abcf5aa94cb2c42ee011fe47603d7c3db1b))
* **blend:** fill concave edges on the correct side of the analytic fillet ([#1319](https://github.com/esaueng/brepkit/issues/1319)) ([283f162](https://github.com/esaueng/brepkit/commit/283f162804525daf926ef3791b172cdaba3b53b8))
* **blend:** material-oriented chamfer contacts on concave edges ([#1312](https://github.com/esaueng/brepkit/issues/1312)) ([6220982](https://github.com/esaueng/brepkit/commit/62209828051c28c3ef5a74a8a08f89606b2031c1))
* **blend:** notch end caps with the fillet end cross-section arcs ([#1309](https://github.com/esaueng/brepkit/issues/1309)) ([dc494fc](https://github.com/esaueng/brepkit/commit/dc494fc55e958743bb844e57d6e6241c1729ef77))
* **blend:** reuse trimmer contact edges in the v2 blend face ([#1305](https://github.com/esaueng/brepkit/issues/1305)) ([de59189](https://github.com/esaueng/brepkit/commit/de5918989e5e7ab2cdc6a644f27c545cfa34a159))
* **blend:** rim chamfer on a cap that carries holes ([#28](https://github.com/esaueng/brepkit/issues/28)) ([7509fd8](https://github.com/esaueng/brepkit/commit/7509fd8ef120e3e8cd44bf86219c931675535a1f))
* **blend:** rim fillet on a cap that carries holes ([#30](https://github.com/esaueng/brepkit/issues/30)) ([422906c](https://github.com/esaueng/brepkit/commit/422906cb4c7914c1185704df22cf67082143e0b5))
* **blend:** stop failed fillets corrupting the model, and close fillet ends ([#14](https://github.com/esaueng/brepkit/issues/14)) ([549b84c](https://github.com/esaueng/brepkit/commit/549b84c51aa6adc42a025deaf4b40455b50e3fc0))
* **blend:** the corner patch was inside out, and the binding returned a silent subset ([#44](https://github.com/esaueng/brepkit/issues/44)) ([626fb6d](https://github.com/esaueng/brepkit/commit/626fb6d47bf07ec56f6f59acefc4e7b410c721ed))
* **blend:** thread chamfer trims into shared contact edges ([#1307](https://github.com/esaueng/brepkit/issues/1307)) ([cc6c113](https://github.com/esaueng/brepkit/commit/cc6c1133d933475fd8ad31379c065e6a8e09c54e))
* **blend:** use the material wedge half-angle in the analytic plane fillet ([#1321](https://github.com/esaueng/brepkit/issues/1321)) ([c9298db](https://github.com/esaueng/brepkit/commit/c9298db52033d15d4a6f0435c4f183e2e75e9ce2))
* **boolean:** parallel-cylinder sections, circular cap boundaries, tangent-pinch fuse acceptance ([#117](https://github.com/esaueng/brepkit/issues/117)) ([d54c74f](https://github.com/esaueng/brepkit/commit/d54c74fa870eba35e5c1c710575c015f991da648))
* bound a solid's box by its faces, not their surfaces ([4f0b76a](https://github.com/esaueng/brepkit/commit/4f0b76a3cfd481397c9a702916876c829a75e59e))
* bound a solid's box by its faces, not their surfaces ([6c5a4ec](https://github.com/esaueng/brepkit/commit/6c5a4ec4c4ffbda132c3078ebae6b92eb9a6c0d8))
* **check:** a hole in a curved face was material, and a bore wall measured nothing ([#49](https://github.com/esaueng/brepkit/issues/49)) ([4367a3e](https://github.com/esaueng/brepkit/commit/4367a3e1d7a2f7393fbf234e298bd471636f8157))
* **check:** a wire's orientation flags must not change what a face measures ([#46](https://github.com/esaueng/brepkit/issues/46)) ([2d4e4ad](https://github.com/esaueng/brepkit/commit/2d4e4adf685b7f22d789491b57845530c29b7476))
* **check:** planar fan triangulation uses signed areas ([#1385](https://github.com/esaueng/brepkit/issues/1385)) ([0f6387f](https://github.com/esaueng/brepkit/commit/0f6387f19cd9a4ec3f4932b8d0c189e409e9194a))
* **check:** subtract face holes in point classification ([#13](https://github.com/esaueng/brepkit/issues/13)) ([514e78d](https://github.com/esaueng/brepkit/commit/514e78d0a96bf63c3b53f072641862ff3c1e3c2f))
* decline unsupported conic band rims ([ae3b424](https://github.com/esaueng/brepkit/commit/ae3b4240a0d012af9803d1e58e7e98cd4b082be2))
* **fillet:** emit straight-edge plane-to-plane blends as exact cylinders ([#40](https://github.com/esaueng/brepkit/issues/40)) ([053061e](https://github.com/esaueng/brepkit/commit/053061e80289b4e441c8526bd9bc6183ea31f154))
* **geometry:** document the per-segment span invariant on arc conversion ([#1183](https://github.com/esaueng/brepkit/issues/1183)) ([cfb0938](https://github.com/esaueng/brepkit/commit/cfb09386fe74c8f2be0341a3044ac4c2589f8cd3))
* **io:** honour EDGE_CURVE same_sense on STEP import ([7b7672a](https://github.com/esaueng/brepkit/commit/7b7672a655e84b252b47d9a51d0758a5a11dae5a))
* keep disconnected coaxial blind holes separate ([c0f4a76](https://github.com/esaueng/brepkit/commit/c0f4a768907e832c1fff31426db1de3d34eb97ad))
* **math:** bezier-clip hull vertex check defeated straight-line clips ([#8](https://github.com/esaueng/brepkit/issues/8)) ([d8ca450](https://github.com/esaueng/brepkit/commit/d8ca450771f4e14b11c4f82e3b800834895b7481))
* **math:** CDT edge recovery must not claim success without the edge ([#1362](https://github.com/esaueng/brepkit/issues/1362)) ([362f1c2](https://github.com/esaueng/brepkit/commit/362f1c2fd4d04a977bd3e59b477c37715e26d10c))
* **math:** emit one breakout loop per angular window in cylinder-cylinder ([7d24b23](https://github.com/esaueng/brepkit/commit/7d24b23745e69584e9674dc95cd33140b13208ca))
* **math:** emit one breakout loop per angular window in cylinder-cylinder ([d034c0a](https://github.com/esaueng/brepkit/commit/d034c0a9e201bca956981af51f5f0e025f8fed10))
* **math:** extend plane-cone section chains to the v_max boundary ([#1379](https://github.com/esaueng/brepkit/issues/1379)) ([d79ee8a](https://github.com/esaueng/brepkit/commit/d79ee8a4a512487a59fe96bc8ac04d29ed560e41))
* **math:** guard CDT constrained-crossing split against welded intersection vertices ([#1391](https://github.com/esaueng/brepkit/issues/1391)) ([3b2bcb5](https://github.com/esaueng/brepkit/commit/3b2bcb5fc5a296d6ba04d28a3ed85c09ca1da486))
* **math:** pad bezier-clip AABB early-exit by intersection tolerance ([#7](https://github.com/esaueng/brepkit/issues/7)) ([ed4bd00](https://github.com/esaueng/brepkit/commit/ed4bd00240ff742801a9dd27904cb5ad3dc04610))
* **measure:** volume must not depend on how a solid was decomposed ([#42](https://github.com/esaueng/brepkit/issues/42)) ([93aaa79](https://github.com/esaueng/brepkit/commit/93aaa79803ce2589dd99640b2612dc27871d88ca))
* **operations:** a corner-diagonal disjoint union is not debris ([6aa7687](https://github.com/esaueng/brepkit/commit/6aa76870425a7192ae6c7ec5501c20d131f01391))
* **operations:** a corner-diagonal disjoint union is not debris ([d6724d2](https://github.com/esaueng/brepkit/commit/d6724d263dbe519cead5e6a16458181c3162c023))
* **operations:** a sweep asked for round corners got smooth ones instead ([#52](https://github.com/esaueng/brepkit/issues/52)) ([5a53a0b](https://github.com/esaueng/brepkit/commit/5a53a0b7a445ac9122f50b0e49392dfe8b9b5874))
* **operations:** accept multi-region booleans with rotated or ring pieces ([6e1e3f8](https://github.com/esaueng/brepkit/commit/6e1e3f804e1a3596f544437233fc767ceef38157))
* **operations:** accept multi-region booleans with rotated or ring pieces ([#1239](https://github.com/esaueng/brepkit/issues/1239)) ([0ce7004](https://github.com/esaueng/brepkit/commit/0ce7004deb2420ffc5cbc8d2d3d0375b7620a91a))
* **operations:** admit Intersect to the multi-region acceptance gate ([#1154](https://github.com/esaueng/brepkit/issues/1154)) ([4e7bf70](https://github.com/esaueng/brepkit/commit/4e7bf7072073bf992f041dbc7ac5e0de46571007))
* **operations:** analytic revolve rim senses must account for face reversal ([#1367](https://github.com/esaueng/brepkit/issues/1367)) ([c8153ab](https://github.com/esaueng/brepkit/commit/c8153ab42a6618c516c89840f616c7fa57b777b9))
* **operations:** chamfer must keep the holes and close the shell ([#43](https://github.com/esaueng/brepkit/issues/43)) ([4c01e47](https://github.com/esaueng/brepkit/commit/4c01e470f8fb08dbb4dc96b0836b898d57d0b5e8))
* **operations:** close the orientation-emission campaign; check_orientation defaults on ([#1377](https://github.com/esaueng/brepkit/issues/1377)) ([fc243b7](https://github.com/esaueng/brepkit/commit/fc243b7ae0ae9531a34baee5f597da4d09af528e))
* **operations:** close the shell on asymmetric chamfers ([d8c84da](https://github.com/esaueng/brepkit/commit/d8c84da2f68316ce2826318bf4f946f56a3ca4b3))
* **operations:** collapse a shell fillet the thickness swallows to a sharp corner ([#1243](https://github.com/esaueng/brepkit/issues/1243)) ([b44551e](https://github.com/esaueng/brepkit/commit/b44551e1b94d3f195b3c2348c4407c7dbbfe10ba))
* **operations:** draft must close the shell it opens, and keep the holes ([#41](https://github.com/esaueng/brepkit/issues/41)) ([6302acb](https://github.com/esaueng/brepkit/commit/6302acbc32cc3b6da7d3a21635ae7ad8a3b21374))
* **operations:** drop absorbed hole wires when unify_faces merges faces ([#11](https://github.com/esaueng/brepkit/issues/11)) ([27814b4](https://github.com/esaueng/brepkit/commit/27814b4afaf4343d88e2d3985a0a1b29231a4ea1))
* **operations:** exact sphere corner caps for rolling-ball fillets ([#33](https://github.com/esaueng/brepkit/issues/33)) ([0f06cf7](https://github.com/esaueng/brepkit/commit/0f06cf785009d210b34ecef69666ed14493413ef))
* **operations:** extrude side wires must match cap traversal senses ([#1371](https://github.com/esaueng/brepkit/issues/1371)) ([b3d65eb](https://github.com/esaueng/brepkit/commit/b3d65ebaaca3d1f7983111bf658ebfaefd6cfb52))
* **operations:** face provenance changed answer with the modelling unit, and most operations had none ([#51](https://github.com/esaueng/brepkit/issues/51)) ([bb92b77](https://github.com/esaueng/brepkit/commit/bb92b77a3b1213015e92a3b533907d863b47c775))
* **operations:** guard fuse_cluster against empty input ([#1207](https://github.com/esaueng/brepkit/issues/1207)) ([d18dd4b](https://github.com/esaueng/brepkit/commit/d18dd4b4d89378abb3ecf9fdb2813ac114bbc080))
* **operations:** hard-fail free boundary edges in the strict boolean gate ([#1192](https://github.com/esaueng/brepkit/issues/1192)) ([55531dd](https://github.com/esaueng/brepkit/commit/55531ddb434d9ff8218325758106714412fd23e4))
* **operations:** imprint grazing edge contacts in the mesh boolean co-refinement ([#1162](https://github.com/esaueng/brepkit/issues/1162)) ([746c396](https://github.com/esaueng/brepkit/commit/746c39614558ac2403aea1a835c288c2a778da4a))
* **operations:** measure NURBS-faced solids off the closed mesh ([#26](https://github.com/esaueng/brepkit/issues/26)) ([64a39f5](https://github.com/esaueng/brepkit/commit/64a39f53f28a7516e27e49bf5d0bf60e5f4cc170))
* **operations:** normalize segmented revolve orientation ([#1237](https://github.com/esaueng/brepkit/issues/1237)) ([6daa2ae](https://github.com/esaueng/brepkit/commit/6daa2ae6da9b6acfa3ae1e10a20341d5458563ff))
* **operations:** per-face tessellation and classification of wavy-band faces ([#1265](https://github.com/esaueng/brepkit/issues/1265)) ([a7c6d69](https://github.com/esaueng/brepkit/commit/a7c6d695c86ebaef7330e42adec30af5cbc9ec0a))
* **operations:** per-face tessellation and classification of wavy-band faces ([#1265](https://github.com/esaueng/brepkit/issues/1265)) ([2942e5d](https://github.com/esaueng/brepkit/commit/2942e5d418b9c5668b76c91a1977a25fbb392cbf))
* **operations:** real winding number, consolidate classify onto check ([#17](https://github.com/esaueng/brepkit/issues/17)) ([88564c7](https://github.com/esaueng/brepkit/commit/88564c7b68cce42f2106d4ae8991f59eac4955cb))
* **operations:** reject chamfer setbacks that do not fit the face ([6409f41](https://github.com/esaueng/brepkit/commit/6409f41f81afb1e88ccf969c6630280a8b53fa60))
* **operations:** reversed-traversal boundary samplers no longer drop polygon corners ([#1383](https://github.com/esaueng/brepkit/issues/1383)) ([40f354e](https://github.com/esaueng/brepkit/commit/40f354e3b1db7fd67212f42a0169298b50372e36))
* **operations:** segmented revolve side wires must reverse with the face ([#1369](https://github.com/esaueng/brepkit/issues/1369)) ([8f2ee3e](https://github.com/esaueng/brepkit/commit/8f2ee3e5127ea412a69df62d2fcd097f2ff34e00))
* **operations:** shell dropped the holes it hollowed and left the result open ([#48](https://github.com/esaueng/brepkit/issues/48)) ([e0e2d7b](https://github.com/esaueng/brepkit/commit/e0e2d7bc4b653dd6032ff23929ff5566bbe224ba))
* **operations:** split must cut the topology, not the vertex positions ([#45](https://github.com/esaueng/brepkit/issues/45)) ([3ebf4cb](https://github.com/esaueng/brepkit/commit/3ebf4cb440145d72f76ee75469293ccc507665ee))
* **operations:** sweep and shared-cap wires reverse with their faces; strict orientation validation by default ([#1373](https://github.com/esaueng/brepkit/issues/1373)) ([3bee9cb](https://github.com/esaueng/brepkit/commit/3bee9cb864b7c210288afabde62e26a31db0b7dc))
* **operations:** sweep miter joins collapsed after sub-curve split ([#6](https://github.com/esaueng/brepkit/issues/6)) ([3e94369](https://github.com/esaueng/brepkit/commit/3e94369ed051d10f62d44c2e5cfca8701c47ed80))
* **operations:** tessellate nested inner wires by even-odd nesting depth ([#1212](https://github.com/esaueng/brepkit/issues/1212)) ([ae39f7b](https://github.com/esaueng/brepkit/commit/ae39f7b8fbdb9e228b33a88254bce304bb3a6b99))
* **operations:** validate multi-component shells per component ([#103](https://github.com/esaueng/brepkit/issues/103)) ([a2f4626](https://github.com/esaueng/brepkit/commit/a2f46260acda6b83b9544c12f60c7378b8ca83b0))
* **operations:** veto materially-overlapping genus-0 outer-shell components in validate ([#104](https://github.com/esaueng/brepkit/issues/104)) ([00fc59a](https://github.com/esaueng/brepkit/commit/00fc59a9194537964de0fef774f8816b26a47d0c))
* place a truncated cone's apex from its declared radius ([#101](https://github.com/esaueng/brepkit/issues/101)) ([7d029dd](https://github.com/esaueng/brepkit/commit/7d029dd738de54b5d0a330a7b38bb2935ff25750))
* preserve exact cylindrical bore resize ([d0dc6dd](https://github.com/esaueng/brepkit/commit/d0dc6ddecc73a7c2e10e46e81fb47e3da8c36990))
* preserve exact cylindrical bore resize ([7ce7312](https://github.com/esaueng/brepkit/commit/7ce7312b78f957b36536beea7ce99d28d35114e1))
* preserve fork curve kinds in sync ([7f294b7](https://github.com/esaueng/brepkit/commit/7f294b7cfdb3d747eb2904033920595681bb5566))
* preserve fork geometry invariants in sync ([39f7188](https://github.com/esaueng/brepkit/commit/39f7188d6f5254a44903776b53a04ad6df8c4e19))
* preserve solid retirement lifecycle ([824a3cb](https://github.com/esaueng/brepkit/commit/824a3cbbdafdba7ac747c6174a4ace646f0aa723))
* read STEP placement attributes by position ([0ecc71c](https://github.com/esaueng/brepkit/commit/0ecc71cbd7beb05332b0ad1c0bd139d98e3ffb14))
* read STEP placement attributes by position ([c908301](https://github.com/esaueng/brepkit/commit/c908301d8b03511459f14a444d620847400ed04e))
* replay Apache-compatible baseline repairs ([#250](https://github.com/esaueng/brepkit/issues/250)) ([49aaac1](https://github.com/esaueng/brepkit/commit/49aaac16f6e4b30c66f8aadcdb928a045ea3955c))
* replay Apache-compatible security hardening ([#252](https://github.com/esaueng/brepkit/issues/252)) ([1079b8c](https://github.com/esaueng/brepkit/commit/1079b8c3c678c6e2bad93b23040345571041fc86))
* replay Apache-compatible STEP periodic repairs ([#251](https://github.com/esaueng/brepkit/issues/251)) ([66ff7a8](https://github.com/esaueng/brepkit/commit/66ff7a8fe96d166402d0c83b07ffff6d65c63758))
* **shell:** emit the chamfer strip a swallowed corner fillet collapses to ([#1324](https://github.com/esaueng/brepkit/issues/1324)) ([4a33256](https://github.com/esaueng/brepkit/commit/4a33256da474b0eb26302367f74d777425aa870e))
* **sphere:** a disjoint cut is an identity; offsetting a sphere emits geometry ([#65](https://github.com/esaueng/brepkit/issues/65)) ([9a90998](https://github.com/esaueng/brepkit/commit/9a90998eb17c6265c59f0850fd2fbfe1a08ddbf9))
* **step:** honour the declared AXIS2_PLACEMENT_3D ref_direction on conics ([e362eed](https://github.com/esaueng/brepkit/commit/e362eed886d23fdbd9defd392f8fd65d7a99b4b7))
* **step:** honour the declared AXIS2_PLACEMENT_3D ref_direction on conics ([c07e69a](https://github.com/esaueng/brepkit/commit/c07e69a5e9eba9a77ede48ddf8d6d5b32093809d))
* **tessellate:** close sphere equatorial seam ([ebdffd1](https://github.com/esaueng/brepkit/commit/ebdffd1127b5d66a6f0d512c2918c92fa0c7e9b9))
* **tessellate:** close sphere equatorial seam ([e5708d6](https://github.com/esaueng/brepkit/commit/e5708d659da40f4e659ebbbcb072e1ddbedb4d82))
* **tessellate:** preserve cylinder inner wires ([d07ef04](https://github.com/esaueng/brepkit/commit/d07ef04d86f07e268b6f812034884529b54f0912))
* two operations that returned wrong-but-plausible solids ([#39](https://github.com/esaueng/brepkit/issues/39)) ([ad0d59d](https://github.com/esaueng/brepkit/commit/ad0d59d56210bbe9809c1155d7fcf66c4eac0b9c))
* **wasm:** route batch chamfer through the same engine chain as the binding ([4b8cdb1](https://github.com/esaueng/brepkit/commit/4b8cdb141ac7ab831a7703cc2c4e6c25ee8c8db8))


### Performance

* **algo:** batch edge sampler for the same-domain polygon builders ([#1160](https://github.com/esaueng/brepkit/issues/1160)) ([9fa713e](https://github.com/esaueng/brepkit/commit/9fa713e20d86d9f4ede8eb56f47487eee74c6e2b))
* **algo:** hoist the NURBS section domain out of the split-finder eval loop ([#1158](https://github.com/esaueng/brepkit/issues/1158)) ([70f632e](https://github.com/esaueng/brepkit/commit/70f632e1ff62ac950547636fc37f0d493e4c7289))
* **algo:** reject coplanar-but-disjoint SD pairs with an oriented box ([#1200](https://github.com/esaueng/brepkit/issues/1200)) ([d16cf8f](https://github.com/esaueng/brepkit/commit/d16cf8feab600715d685c6630f0daa914b77ce85))
* **fillet:** clear the degeneracy guard on a cheap boundary area first ([8cf5f83](https://github.com/esaueng/brepkit/commit/8cf5f83c6cc00ee01a48b8e6e02cfc5120e4bcea))
* **fillet:** stop tessellating every face to check for degeneracy ([#1248](https://github.com/esaueng/brepkit/issues/1248)) ([3f64677](https://github.com/esaueng/brepkit/commit/3f64677270b150e4bdf64b3256cb557c350fd70a))
* **operations:** batch compound_cut when the tools form one cluster ([#1198](https://github.com/esaueng/brepkit/issues/1198)) ([c976efd](https://github.com/esaueng/brepkit/commit/c976efd026f2d5d2518b3e1b8f77e0a4ac439580))
* **operations:** batch pairwise-disjoint compound_cut tools into one cut ([#1164](https://github.com/esaueng/brepkit/issues/1164)) ([435ac9a](https://github.com/esaueng/brepkit/commit/435ac9a586d0eb4d41990e46dd6861f4a80e1e5b))
* **operations:** cluster-batch overlapping compound_cut tools ([#1170](https://github.com/esaueng/brepkit/issues/1170)) ([f2df68d](https://github.com/esaueng/brepkit/commit/f2df68d08780eb1ecfe30079d51bf979ea089270))
* **operations:** exact sag bound for display sphere tessellation ([#1389](https://github.com/esaueng/brepkit/issues/1389)) ([2e325c7](https://github.com/esaueng/brepkit/commit/2e325c782317ebd4121dc0776a28f4668af1b93c))
* **operations:** fuse_all uses the N-way fuse for connected clusters ([#1205](https://github.com/esaueng/brepkit/issues/1205)) ([439d29e](https://github.com/esaueng/brepkit/commit/439d29e12ee849c8db98b757eef99ada303aa56d))
* **operations:** short-circuit disjoint Cut to a target copy ([#1252](https://github.com/esaueng/brepkit/issues/1252)) ([1152a86](https://github.com/esaueng/brepkit/commit/1152a86e7418c09b5944e2668b3cf1be38b6064a))
* **operations:** short-circuit disjoint Cut to a target copy ([#1252](https://github.com/esaueng/brepkit/issues/1252)) ([a6d5997](https://github.com/esaueng/brepkit/commit/a6d59972ecea44a25120884fe38f2785a0ec6ad0))
