...
## [4.0.0](https://github.com/esaueng/brepkit/compare/v3.2.32...v4.0.0) (2026-08-14)
...
* **blend:** add exact direct blend editing foundations ([43bbccf](https://github.com/esaueng/brepkit/commit/43bbccfd65f6bd3c590707847b07f2af519ab19f))
* **blend:** add exact direct blend editing foundations ([d731cf7](https://github.com/esaueng/brepkit/commit/d731cf777ca800f13bb3521c0245a5c090f08ebd))
* **operations:** add exact blend resizing ([b3b1105](https://github.com/esaueng/brepkit/commit/b3b11058e85851e5d0ca8461fa16bf0cc14a46f1))
* **operations:** add exact blend resizing ([9b57102](https://github.com/esaueng/brepkit/commit/9b57102796eecb2bedd51d85dc0cff38f5760d5f))
* **operations:** analytic sweep along closed planar line/arc spines ([#1427](https://github.com/esaueng/brepkit/issues/1427)) ([1d8c4ad](https://github.com/esaueng/brepkit/commit/1d8c4adb0d7d5042c827d6d77de16a237c1fda66))
* **operations:** mesh-fallback counter and simplify-honoring boolean bindings ([#1450](https://github.com/esaueng/brepkit/issues/1450)) ([62b4719](https://github.com/esaueng/brepkit/commit/62b471918280eff4206e1f886e11cef4e0d8fef3))
* **operations:** union robustness census example ([86ae8a0](https://github.com/esaueng/brepkit/commit/86ae8a0917b8eb282aafea57dd405a23f36a1c59))
* **operations:** union robustness census example ([2c19684](https://github.com/esaueng/brepkit/commit/2c19684ab02db338b99a2cff69c7689c90d768bc))
* **operations:** warn on hazardous periodic rims ([04f4750](https://github.com/esaueng/brepkit/commit/04f4750ee3e1d1d73ba8231dbe21fe850263f413))
* relicense under AGPL-3.0-only with commercial licensing option ([#1416](https://github.com/esaueng/brepkit/issues/1416)) ([bd7d1ba](https://github.com/esaueng/brepkit/commit/bd7d1ba7de6b88a5e997e5281e00a96be30f597f))


### Bug Fixes

* **algo:** avoid quadratic pendant pruning ([2dab305](https://github.com/esaueng/brepkit/commit/2dab3055b81998e94796b28c6114a9850d4d64d2))
* **algo:** avoid quadratic pendant pruning in `remove_pendant_sections` ([ab7b230](https://github.com/esaueng/brepkit/commit/ab7b2307516b91c6b8ae462b7107f482607c80c8))
* **algo:** avoid vertex-only AABB pruning in N-way fuse by processing every source pair ([99a9703](https://github.com/esaueng/brepkit/commit/99a970303c29597c532a603c267b886613bd604b))
...
* **algo:** bound interior chord sampling ([316cd32](https://github.com/esaueng/brepkit/commit/316cd320775eaa0bac5099fbff81ab57eec90646))
* **algo:** bound interior chord sampling to mitigate quadratic CPU path ([576992a](https://github.com/esaueng/brepkit/commit/576992aa6970f9cf0d8c4e03606f461a1e209059))
* **algo:** bound widened EF vertex lookup ([c21b38d](https://github.com/esaueng/brepkit/commit/c21b38dc53f34f9fc12070eb0a89a90211d3d76a))
* **algo:** bound widened EF vertex lookup ([b5a629d](https://github.com/esaueng/brepkit/commit/b5a629d8eba5915c7bd0cf9aca5a78d49678072d))
* **algo:** canonical same-domain key for closed ellipse edges too ([5eb2590](https://github.com/esaueng/brepkit/commit/5eb2590ba08cf3e2af04decb6faf3cf436a25cbe))
* **algo:** canonical same-domain key for closed ellipse edges too ([98eda8e](https://github.com/esaueng/brepkit/commit/98eda8e03afd165acd8b13fddc33a7ecc4376274))
* **algo:** classify plane split loops on arc-true via-frame polygons ([#1394](https://github.com/esaueng/brepkit/issues/1394)) ([f530e58](https://github.com/esaueng/brepkit/commit/f530e58f187f7c9720c37910b52c44a95ca2e4bc))
* **algo:** clip a holed face's section to the true arc, not its chord ([#1510](https://github.com/esaueng/brepkit/issues/1510)) ([#1514](https://github.com/esaueng/brepkit/issues/1514)) ([12f85f6](https://github.com/esaueng/brepkit/commit/12f85f6ca8a328ef097c2e3b667cd32341f36c35))
* **algo:** cross a band's rim arcs when trimming a faceted-ramp section ([#1534](https://github.com/esaueng/brepkit/issues/1534)) ([4970aa9](https://github.com/esaueng/brepkit/commit/4970aa9fbfcc76b8f2990443d483c2cb6a6dde70))
* **algo:** cut a cylinder band at the ring sections, not only at the notch ([#1530](https://github.com/esaueng/brepkit/issues/1530)) ([76eb71f](https://github.com/esaueng/brepkit/commit/76eb71f75bd77592b876463b596ab052e5e3bac3))
* **algo:** DCEL rescue for non-periodic band grand tours ([#1453](https://github.com/esaueng/brepkit/issues/1453)) ([53536cc](https://github.com/esaueng/brepkit/commit/53536cc61751b378e454fde67d131ef86e550b89))
...
* **algo:** hoist NURBS clipping domain projection ([d012d0a](https://github.com/esaueng/brepkit/commit/d012d0aa11bdac8d9add37fd9ac1b59672ea52b6))
* **algo:** hoist trimmed NURBS domain projection out of arc bisection loop ([580075d](https://github.com/esaueng/brepkit/commit/580075d80a0b74c1c690777bd4ad51109c6a02fe))
* **algo:** keep geometric registry matching for id-less sections ([3d06613](https://github.com/esaueng/brepkit/commit/3d066135cabfed3bbffee4872185a219d9551217))
* **algo:** keep pinch-shim faces through within-rank same-domain dedup ([#1463](https://github.com/esaueng/brepkit/issues/1463)) ([2d50f28](https://github.com/esaueng/brepkit/commit/2d50f281cb6e12a2eb22cb8eef4bc5bf79e017d7))
...
* **algo:** peel pendant sections in deterministic order ([#1432](https://github.com/esaueng/brepkit/issues/1432)) ([364d556](https://github.com/esaueng/brepkit/commit/364d5569f5d818f52c358706e9d9279857b46067))
* **algo:** preserve both box-cylinder side lobes ([f9c60a3](https://github.com/esaueng/brepkit/commit/f9c60a37373ff6a9b32dfd536b94ed3386f36b35))
* **algo:** preserve fork cylinder-band splitting ([37f2306](https://github.com/esaueng/brepkit/commit/37f2306ea7e88e7ca66c6829564bfe35109994b1))
* **algo:** preserve holes in partial overlap caps ([2375f16](https://github.com/esaueng/brepkit/commit/2375f1699d38bec5db55a8e5558ca56d25b0a27f))
* **algo:** preserve holes in partial-overlap caps ([1c1bce4](https://github.com/esaueng/brepkit/commit/1c1bce48c9cc1f05a7914ee4a15d32540c915533))
* **algo:** preserve meridian winding samples ([7a7be6e](https://github.com/esaueng/brepkit/commit/7a7be6e4569fe614e8692d3670ed9f2c8ac9d96b))
* **algo:** preserve meridian winding samples ([1059267](https://github.com/esaueng/brepkit/commit/1059267922433be804f4c10566626c5b2ea697b8))
* **algo:** process every N-way fuse pair ([67ea8fb](https://github.com/esaueng/brepkit/commit/67ea8fb9b0e27d8f4c05452436492d8ac6475783))
* **algo:** restore partial-overlap same-domain pairing ([ed2081e](https://github.com/esaueng/brepkit/commit/ed2081ef7cb562ee17a92f54000ae7c26edae417))
* **algo:** restore partial-overlap same-domain pairing reverted by [#229](https://github.com/esaueng/brepkit/issues/229) ([7742abe](https://github.com/esaueng/brepkit/commit/7742abeeb25d8144725b20711401a7ddbb05544b))
* **algo:** scale face splitter bridge bands ([402e9a2](https://github.com/esaueng/brepkit/commit/402e9a2160c6befd03885f2cff360ba5140c363a))
* **algo:** scale face splitter bridge bands ([10d1992](https://github.com/esaueng/brepkit/commit/10d199214bb6ffc93b55c8ac293f0c57faee64ad))
* **algo:** scope split registry anchors by pave block ([7751ffa](https://github.com/esaueng/brepkit/commit/7751ffa93a3e712972562db355a1f1b85459a8b4))
* **algo:** scope split registry anchors by pave block ([08b0e16](https://github.com/esaueng/brepkit/commit/08b0e16151058a6d691fae81cde4038b53914d78))
* **algo:** span a rim arc the way the kernel defines it, not the short way ([#1540](https://github.com/esaueng/brepkit/issues/1540)) ([ed8dfc7](https://github.com/esaueng/brepkit/commit/ed8dfc798866b462ecba9587d4cc078674cbaa39))
* **algo:** stream same-domain overlap candidates ([3b25937](https://github.com/esaueng/brepkit/commit/3b259376b02415a2aa4adbe329a2aa5dc7041a7f))
* **algo:** stream same-domain overlap candidates to bound broad-phase memory ([1c485cc](https://github.com/esaueng/brepkit/commit/1c485cc573367796ab4c7b37d49e8d722413c1cf))
...
* **algo:** veto line sections that only graze a plane face's rim ([dbb033f](https://github.com/esaueng/brepkit/commit/dbb033f3c5ed7dccfafecf96cba1525df921924d))
* **algo:** veto line sections that only graze a plane face's rim ([3fa0096](https://github.com/esaueng/brepkit/commit/3fa0096b685ec245fb999e68d50592bb04bd2923))
* **blend:** accept whole-part and duplicated fillet selections ([19d6947](https://github.com/esaueng/brepkit/commit/19d694775afd788e21c9991996eec25cb508e282))
* **blend:** accept whole-part and duplicated fillet selections ([d50292a](https://github.com/esaueng/brepkit/commit/d50292ad149bca33810d74a205603e0f287f406b))
* **blend:** close the closed-rim and mixed-radius fillet classes (scoop repro 56 → 0 free) ([#1460](https://github.com/esaueng/brepkit/issues/1460)) ([a128062](https://github.com/esaueng/brepkit/commit/a1280628498e1f9147b93004cbc438771e3bf7cc))
* **blend:** close the fillet junction lens and pinch classes (grouped-scoop cases 2+3) ([#1465](https://github.com/esaueng/brepkit/issues/1465)) ([b74c9ac](https://github.com/esaueng/brepkit/commit/b74c9ac8b168bdc5eedf03d428755e19aa05eda8))
* **blend:** emit orientation-consistent faces from the v2 fillet ([#1466](https://github.com/esaueng/brepkit/issues/1466)) ([f1b2cd1](https://github.com/esaueng/brepkit/commit/f1b2cd143e60b434ac7746441fbfbf0c1abe7de2))
* **blend:** retain cross edges for near-pinched stripes by using closure tolerance ([0fb0469](https://github.com/esaueng/brepkit/commit/0fb0469967393f2dd409a6188818f89d7c8eaf11))
* **blend:** retain near-pinch cross edges ([c0ad0d1](https://github.com/esaueng/brepkit/commit/c0ad0d19112db32bf59ed67522f462631f2c24df))
* **blend:** reuse nonuniform straight contacts ([af61eb4](https://github.com/esaueng/brepkit/commit/af61eb4cce128abbc3b3cd5cc3d7542a0a15b632))
* **blend:** reuse nonuniform straight contacts ([60a81b2](https://github.com/esaueng/brepkit/commit/60a81b2016ea4a38d3030a217a0fba3303397a58))
* **blend:** trimmer and corner hardening from the closed-rim scoop repro ([#1457](https://github.com/esaueng/brepkit/issues/1457)) ([65096a2](https://github.com/esaueng/brepkit/commit/65096a212634b11c24fa8133b0cd6d353247cf87))
* **blend:** validate reused contact geometry ([5895de7](https://github.com/esaueng/brepkit/commit/5895de780259fbe5d6e6557aad00e47136be4afd))
* **blend:** validate reused contact geometry ([d28ee8e](https://github.com/esaueng/brepkit/commit/d28ee8e6dd4a35020e9426c56a42e68a353d3108))
* **boolean:** parallel-cylinder sections, circular cap boundaries, tangent-pinch fuse acceptance ([#117](https://github.com/esaueng/brepkit/issues/117)) ([1e37d75](https://github.com/esaueng/brepkit/commit/1e37d75c0590a7a33006d9d0d0a7a0cdd8e753ab))
* **boolean:** reject non-manifold tangent pinches ([abd14fc](https://github.com/esaueng/brepkit/commit/abd14fc25ac673a73bc4cc2b531ba23501a0947b))
* **boolean:** reject non-manifold tangent pinches ([1dbaece](https://github.com/esaueng/brepkit/commit/1dbaecef8316fb967367f8c72840b0ddd735afee))
* **boolean:** reject sampled NURBS disjoint proofs ([0de0ee4](https://github.com/esaueng/brepkit/commit/0de0ee4d96fbe5864bec9f7bfb03433b2905bf55))
* **boolean:** reject sampled NURBS disjoint proofs ([14fa34a](https://github.com/esaueng/brepkit/commit/14fa34a1a99bb789873b1a226ca971d57209b7e4))
* bound cylinder hole tessellation work ([3433607](https://github.com/esaueng/brepkit/commit/3433607370625c60163d0970e65b6cc5b4fa6bb4))
* **build:** pin workspace sibling requirements to exact versions ([10bb627](https://github.com/esaueng/brepkit/commit/10bb627e452ef8fb2794f91fd016cbcb31907f92))
* **build:** pin workspace sibling requirements to exact versions ([2cc97d6](https://github.com/esaueng/brepkit/commit/2cc97d61d9c1f5b99f0dd5be04a44d4372de5330))
* **check:** bound curved face trim integration ([a0c0ffb](https://github.com/esaueng/brepkit/commit/a0c0ffbf06af7dfca07e58abe1ff5bc98a42f0e9))
* **check:** bound curved face trim integration ([0a6e524](https://github.com/esaueng/brepkit/commit/0a6e524d820895da3b42fb9c887f0be7f0519d5e))
* **check:** count a ray hit in a face hole as no crossing ([#1526](https://github.com/esaueng/brepkit/issues/1526)) ([fce8068](https://github.com/esaueng/brepkit/commit/fce80681d6c525ef817e24e85bce5fe0925c3611))
* **fillet:** measure holed faces exactly ([543fe8d](https://github.com/esaueng/brepkit/commit/543fe8d1debf1dc3d556896cce23987d8007fa5f))
* **fillet:** reject non-manifold weld results ([d0a0584](https://github.com/esaueng/brepkit/commit/d0a0584127ad30f68ec274ffcdda4763977f7062))
* **fillet:** reject non-manifold weld results ([d1a26f0](https://github.com/esaueng/brepkit/commit/d1a26f0d34437a2b90df69f567890be6a4dbf6a3))
* **fillet:** validate net area for holed faces ([6459952](https://github.com/esaueng/brepkit/commit/6459952f4d5fcd3965befed0b8f0f5dba9c7ffa8))
* **geometry:** require full torus band winding ([97a4b7d](https://github.com/esaueng/brepkit/commit/97a4b7d82b3685fe6d6291f344b241dc09fd1cb8))
* **heal:** apply reshape actions across cavity shells ([f9c0ae3](https://github.com/esaueng/brepkit/commit/f9c0ae30fabfcb9a27cb1707132763835cdcc8dd))
* **heal:** apply reshape actions across cavity shells ([1934d00](https://github.com/esaueng/brepkit/commit/1934d00ce292fb3aac9b737584e7f8b78a4e1cca))
* **heal:** bound split rim midpoint validation ([8f2c7d6](https://github.com/esaueng/brepkit/commit/8f2c7d659359c525e19483b3cc6fe4987fc72cf2))
* **heal:** bound split rim midpoint validation to avoid quadratic DoS ([0dd1a76](https://github.com/esaueng/brepkit/commit/0dd1a7644e6c7b4baeac951f9991efcd972ea640))
* **heal:** deduplicate cavity shells in linear time ([859e026](https://github.com/esaueng/brepkit/commit/859e026d78a724d2d262ec061ccebe6ad94f5c19))
* **heal:** deduplicate cavity shells in linear time ([767e548](https://github.com/esaueng/brepkit/commit/767e5486b6a9ab9893a1dffe064546dbb7b43ce1))
* **heal:** preserve reversed split traversal ([c7d52fd](https://github.com/esaueng/brepkit/commit/c7d52fdd8e73130bc8cfb0122237e79dfcb1ebf9))
* **heal:** require matching face boundaries for deduplication ([63387bb](https://github.com/esaueng/brepkit/commit/63387bb2cb0c82f0d504aed2a6013d555297b46c))
* **heal:** require matching face boundaries for deduplication ([d58ba61](https://github.com/esaueng/brepkit/commit/d58ba61f7ab7d5046bb10fb9a2a4b8f20369752e))
* **io:** bound PLY polygon triangulation ([938a731](https://github.com/esaueng/brepkit/commit/938a7315026be402c48c6fff8ac4b35434507f09))
* **io:** bound PLY polygon triangulation ([6a5fd83](https://github.com/esaueng/brepkit/commit/6a5fd830b458fcd1cbd7a500609623d14827ae98))
* **io:** bound STEP face classification work ([9b6f177](https://github.com/esaueng/brepkit/commit/9b6f1776a37d6cec9466aa990601cf7baf86d0a8))
* **io:** canonicalize safe split circle rims ([b75dd0d](https://github.com/esaueng/brepkit/commit/b75dd0db1283af67f7ad554546a3e046c9812f68))
* **io:** cap work & sampling for generic STEP face-bound classification ([8ef3957](https://github.com/esaueng/brepkit/commit/8ef395757110420bb40995c7dccae1e1bc073291))
* **io:** classify generic periodic STEP face bounds ([7956e0c](https://github.com/esaueng/brepkit/commit/7956e0ca3c3277821ad22047f7a76bc20b7664b2))
* **io:** classify generic STEP face bounds ([5c07fd6](https://github.com/esaueng/brepkit/commit/5c07fd61dfe60a580df962e619c27f3a33288ad1))
* **io:** classify generic STEP face bounds ([0f100d6](https://github.com/esaueng/brepkit/commit/0f100d656a0dda6febda1d32d4175af692cc3d70))
* **io:** classify periodic STEP face bounds ([359c98b](https://github.com/esaueng/brepkit/commit/359c98be4351a864bc7908a1bc5380a45ef6ef82))
* **io:** fail closed for generic multi-bound cone faces (reject periodic UV classification) ([863f512](https://github.com/esaueng/brepkit/commit/863f512ccb41c932fea373c040519cdd8e4421d3))
* **io:** make arena deserialization atomic ([e72d83b](https://github.com/esaueng/brepkit/commit/e72d83b88c51ccac2614cc1891fcb29c6baf0338))
* **io:** make arena deserialization atomic and validate deserialized NURBS/surfaces ([52c9cd4](https://github.com/esaueng/brepkit/commit/52c9cd49eadea1a592f846b5e3fdc7096fd7f73a))
* **io:** make STEP imports transactional ([6698670](https://github.com/esaueng/brepkit/commit/6698670772dc0b0242d5a42a99b56439a5b1d2a2))
* **io:** make STEP imports transactional ([92ef4a8](https://github.com/esaueng/brepkit/commit/92ef4a8dc6927246273f3187bb079df3dc9cdb50))
* **io:** pin the [#1510](https://github.com/esaueng/brepkit/issues/1510) label-bracket fuse repro and the probes that found it ([#1512](https://github.com/esaueng/brepkit/issues/1512)) ([c59f0db](https://github.com/esaueng/brepkit/commit/c59f0db16d8a5ea053639c26cc187676b5284d54))
* **io:** preserve split-rim layer boundary ([35f72bb](https://github.com/esaueng/brepkit/commit/35f72bb1bb64557f29c0c040403c5eb84c0f0329))
* **io:** re-ground the mixed-socket attribution on the directed half-edge oracle ([#1402](https://github.com/esaueng/brepkit/issues/1402)) ([e7e1ff1](https://github.com/esaueng/brepkit/commit/e7e1ff115dfbd6d96587c79f69b06c175beb07c0))
* **io:** reject cyclic oriented STEP shells ([f4e5b40](https://github.com/esaueng/brepkit/commit/f4e5b40228524cfca7d816d06eac4ec8b60931c4))
* **io:** reject cyclic ORIENTED_CLOSED_SHELL references ([aab6745](https://github.com/esaueng/brepkit/commit/aab674581de60ac143a422b30ee6ebb04d94ae06))
* **io:** reject unsafe generic cone bound classification ([2ad2932](https://github.com/esaueng/brepkit/commit/2ad2932720b270c20d4d9869ea1c3c051d6623fd))
* **io:** reject zero-vertex ASCII PLY faces ([255633a](https://github.com/esaueng/brepkit/commit/255633af052784c9ffbde9e733711a7d4f560eac))
* **io:** reject zero-vertex ASCII PLY faces ([46cddaa](https://github.com/esaueng/brepkit/commit/46cddaae6534906f87e2bf982105ad96c62ac324))
* **io:** stream STEP statements ([2b56160](https://github.com/esaueng/brepkit/commit/2b561604959cda0379ac33c7e6f949ed1d7b23bb))
* **io:** validate arena solid references before replay ([d98ab8a](https://github.com/esaueng/brepkit/commit/d98ab8a157d2ffd8659fef71c6c9c2a68a6e58ef))
* **io:** validate arena solid references before replay ([e19ae83](https://github.com/esaueng/brepkit/commit/e19ae835eb990afa31c6369859faff5871500233))
* keep holed periodic face bounds conservative ([a772846](https://github.com/esaueng/brepkit/commit/a7728466c1310f9b050979ca50e7c7411c9cfd04))
* **math:** avoid unsound analytic-analytic intersection rejection ([5cc9c1c](https://github.com/esaueng/brepkit/commit/5cc9c1c2616ac890e2e46a03c8dc946fb3361e32))
* **math:** avoid unsound surface intersection rejection ([bd99dca](https://github.com/esaueng/brepkit/commit/bd99dcabbbfe2990d9c4a24c36fdb9e0bcf893a7))
* **math:** bound CDT constraint recovery so a runaway cannot abort the kernel ([#1520](https://github.com/esaueng/brepkit/issues/1520)) ([87407b9](https://github.com/esaueng/brepkit/commit/87407b90f4da5643efde37dba588ba7a3edabb73))
* **math:** emit one breakout loop per angular window in cylinder-cylinder ([db17ef6](https://github.com/esaueng/brepkit/commit/db17ef6d2c28819da7b477b1a2bf5fbd43b41cd2))
* **math:** emit one breakout loop per angular window in cylinder-cylinder ([2c5b792](https://github.com/esaueng/brepkit/commit/2c5b792e8a3f3684d7d003c6e3893ffc587497b3))
* **math:** reject degree-zero NURBS curves ([71e7b14](https://github.com/esaueng/brepkit/commit/71e7b1481d7f876697c86bda0ffe0ef967974e24))
* **math:** reject degree-zero NURBS curves ([1cc3a5a](https://github.com/esaueng/brepkit/commit/1cc3a5ae7021aae4a2dfd8ba33232972c5fd30dc))
* **math:** reject invalid NURBS curve degrees ([d5abe90](https://github.com/esaueng/brepkit/commit/d5abe90123ef704a7c6a215afe3de39f8f677082))
* **math:** reject invalid NURBS curve degrees ([14821f4](https://github.com/esaueng/brepkit/commit/14821f48d09b5649144a4424047564d2986dd003))
* **math:** reject malformed NURBS knot vectors ([60283df](https://github.com/esaueng/brepkit/commit/60283df2b1e0b664f90e23e247674eb16f7d54fd))
* **math:** reject reversed NURBS domains ([c56eb81](https://github.com/esaueng/brepkit/commit/c56eb8102dd0248b17073f7e47e53e6244efb851))
* **math:** reject reversed NURBS domains ([272adef](https://github.com/esaueng/brepkit/commit/272adef426b77fb8387a0445381c3876bf77a06c))
* **math:** reject skew cone-cylinder algebraic intersections ([37f9396](https://github.com/esaueng/brepkit/commit/37f9396a9e280a8ee6204f3d69de215465497e17))
* **math:** reject skew cone/cylinder algebraic intersections ([bbade58](https://github.com/esaueng/brepkit/commit/bbade5800ff4c6942c50fc964f1aba89c87dec5c))
* **math:** tolerate ulp-level knot wobble in knot-value validation ([d96205b](https://github.com/esaueng/brepkit/commit/d96205b10e1d994d3a81966eaa51e39746d6a081))
* **measure:** bound volume tessellation by curved extent ([a99c3cf](https://github.com/esaueng/brepkit/commit/a99c3cf6c514d617d20d1da21683d193cfbcdfb5))
* **measure:** bound volume tessellation by curved extent ([d497135](https://github.com/esaueng/brepkit/commit/d497135c11be182b3d50b56597962239962d5893))
* **measure:** count cavity shells in volume, area and centre of mass ([#1541](https://github.com/esaueng/brepkit/issues/1541)) ([5ffdb4a](https://github.com/esaueng/brepkit/commit/5ffdb4a1a30de2903f6b4c2ea4ff2c4bfc08c022))
* **offset:** bound cavity overlap checks ([ef658f2](https://github.com/esaueng/brepkit/commit/ef658f2656b7eb4f45b993bc3b6d1af66bc23c52))
* **offset:** limit cavity overlap checks to prevent quadratic CPU DoS ([19db1d9](https://github.com/esaueng/brepkit/commit/19db1d97aff1e49bc40ecc01e42bbfdd968be23d))
* **offset:** reject collapsing cavity offsets ([8234e7b](https://github.com/esaueng/brepkit/commit/8234e7be650e1466ef8bc361f51d567abbdc0268))
* **offset:** reject collapsing cavity offsets ([4f91e27](https://github.com/esaueng/brepkit/commit/4f91e27b639d75b72e9bab70ee08fc344d219a51))
* **operations:** a corner-diagonal disjoint union is not debris ([483883d](https://github.com/esaueng/brepkit/commit/483883d4b9ac3f037b1ff08d0bbefe2bbe090fb0))
* **operations:** a corner-diagonal disjoint union is not debris ([276324a](https://github.com/esaueng/brepkit/commit/276324a761cdb869c0e2833054349c21f52c03a6))
* **operations:** assemble the shell rim from sorted boundary edges ([#1434](https://github.com/esaueng/brepkit/issues/1434)) ([1799017](https://github.com/esaueng/brepkit/commit/17990172da7e41f3beb47bb560f62145a79401e5))
* **operations:** avoid quadratic split-rim scans ([ee9a663](https://github.com/esaueng/brepkit/commit/ee9a66394b7a79a61379bae1c45ce2e2eef5b632))
* **operations:** avoid repeated rim cycle scans ([a0f8b12](https://github.com/esaueng/brepkit/commit/a0f8b129521dacc9a2554e89b915700b8f314f0c))
* **operations:** bail compound_cut batching on fallback-tainted cluster fuses ([#1495](https://github.com/esaueng/brepkit/issues/1495)) ([e78d905](https://github.com/esaueng/brepkit/commit/e78d905cd85cd07b640d90fab8d65aef06a24c73))
* **operations:** bound circular pattern fitting ([01d9c6f](https://github.com/esaueng/brepkit/commit/01d9c6fd6771ddc55bedcb9936837c3220472c78))
* **operations:** bound circular pattern fitting ([483915b](https://github.com/esaueng/brepkit/commit/483915b9934600fd53b82c55a7853cebd07b1702))
* **operations:** bound component intersection checks ([7b3ad23](https://github.com/esaueng/brepkit/commit/7b3ad233fe9a558b7ea6b2a5e82be1bc28538667))
* **operations:** bound component intersection checks ([7625383](https://github.com/esaueng/brepkit/commit/7625383d625f00fe65f5f9d9299d563d738313bb))
* **operations:** bound component overlap validation ([ebc590e](https://github.com/esaueng/brepkit/commit/ebc590ea40b9c17136abef28f263614f5591205d))
* **operations:** bound component overlap validation ([0891f73](https://github.com/esaueng/brepkit/commit/0891f735e3238f00246b3d47bacbd003aff23efc))
* **operations:** bound compound cut batching ([4fbb36a](https://github.com/esaueng/brepkit/commit/4fbb36a006f94e0e990fa19f06098d1d1d256524))
* **operations:** bound compound_cut batching to prevent quadratic DoS ([727a4b9](https://github.com/esaueng/brepkit/commit/727a4b906169d386e898737337cbcd746352b9af))
* **operations:** bound edge projection sampling ([c177a58](https://github.com/esaueng/brepkit/commit/c177a58d051a9d7ff23ca49bd77e4d0be61e1536))
* **operations:** bound face connectivity construction ([01fba0e](https://github.com/esaueng/brepkit/commit/01fba0e19f10922f007be38d1f149f3cc7e0a1a4))
* **operations:** bound helical sweep work ([b0cea5d](https://github.com/esaueng/brepkit/commit/b0cea5d21c09efbea0c536e34a4814610889a4eb))
* **operations:** bound helical sweep work to prevent unbounded allocations ([a247180](https://github.com/esaueng/brepkit/commit/a24718028c74d77b4d2347845b39b9a35f0de947))
* **operations:** bound hidden-line projection sampling ([770b002](https://github.com/esaueng/brepkit/commit/770b002ae7b4d0850490dcaa0d440a871ce6e689))
* **operations:** bound Minkowski sum work ([2afcda0](https://github.com/esaueng/brepkit/commit/2afcda06d452d948a4d35cc2b8ec061d234060b9))
* **operations:** bound Minkowski sum work ([5d98f54](https://github.com/esaueng/brepkit/commit/5d98f54ffcf15ad98a3c03186bf44038623b1a3d))
* **operations:** bound nested wire classification ([29abf05](https://github.com/esaueng/brepkit/commit/29abf0551f7f67a2c071a8d3c1c8f936dcff7c45))
* **operations:** bound nested-wire classification to avoid quadratic DoS ([25918fd](https://github.com/esaueng/brepkit/commit/25918fdc0bdcd1d9d960eaf76bf2058c352ffef1))
* **operations:** bound NURBS trim recovery work ([b84b183](https://github.com/esaueng/brepkit/commit/b84b183b1ec808bb3835e6762e8bbb30b8daebd1))
* **operations:** bound NURBS trim recovery work ([c03f7d6](https://github.com/esaueng/brepkit/commit/c03f7d6e24c6e4147e8e9a6e828f9ed1049ea89d))
* **operations:** bound periodic rim validation ([5a80b3f](https://github.com/esaueng/brepkit/commit/5a80b3f5dfed6ec5e221b9fc7c156a85e7fc7b93))
* **operations:** bound periodic rim validation and cap ambiguous-arc diagnostics ([4cebc7a](https://github.com/esaueng/brepkit/commit/4cebc7aa6db9a54b246f497dfd36105af525254d))
* **operations:** bound the boolean flatten pre-pass recursion ([7cff90e](https://github.com/esaueng/brepkit/commit/7cff90e8c1008828daa2b62a8d4293a08123d1b8))
* **operations:** bound the boolean flatten pre-pass recursion ([dbe6799](https://github.com/esaueng/brepkit/commit/dbe679991770b8a6e5b50d0aa1cb192b91504229))
* **operations:** centralize the sphere-patch plane thresholds on kernel tolerance ([#1410](https://github.com/esaueng/brepkit/issues/1410)) ([43e597f](https://github.com/esaueng/brepkit/commit/43e597f74d98c894bb1bd23f1cf2ed972484c5dd))
* **operations:** close 9 of 11 red-baseline tests across revolve, fuse, and split ([06a09d1](https://github.com/esaueng/brepkit/commit/06a09d1b2ca8550370116a83091c6eb6d6d7d62a))
* **operations:** close 9 of 11 red-baseline tests across revolve, fuse, and split ([6490ca8](https://github.com/esaueng/brepkit/commit/6490ca8e165071ae1bf22cd7aafb47522fa917fb))
* **operations:** close concave blend baselines ([fcad687](https://github.com/esaueng/brepkit/commit/fcad687fe929560e63436396e9a4959afc9d45c5))
* **operations:** close concave blend baselines ([7e3fdd9](https://github.com/esaueng/brepkit/commit/7e3fdd99d734306028bd49c648d5dcf2ad6f082b))
* **operations:** correct the box-sphere octant shortcut and sphere-patch classification ([#1408](https://github.com/esaueng/brepkit/issues/1408)) ([3159636](https://github.com/esaueng/brepkit/commit/31596366768a20043498fd985459a5dd82617c1d))
* **operations:** correct the shell cavity face senses end to end ([#1435](https://github.com/esaueng/brepkit/issues/1435)) ([ea8204f](https://github.com/esaueng/brepkit/commit/ea8204fab9144bf046fb23190fbc3ec024c54394))
* **operations:** cover constraint-recovery Steiner vertices in the CDT lift ([#1489](https://github.com/esaueng/brepkit/issues/1489)) ([5358552](https://github.com/esaueng/brepkit/commit/5358552b7067cd021603972e8e3c9e94b1121149))
* **operations:** drop sub-resolution polygons in mixed boolean assembly ([#1423](https://github.com/esaueng/brepkit/issues/1423)) ([56da284](https://github.com/esaueng/brepkit/commit/56da2846891ccf3bcb45eb9ad8201a37e91c8579))
* **operations:** exact miter sweep via domain-correct frames and a shared bisector ring ([#1448](https://github.com/esaueng/brepkit/issues/1448)) ([6cc0ab0](https://github.com/esaueng/brepkit/commit/6cc0ab09e147c16ca55f1240e9b70df37fbc8261))
* **operations:** false trivial-containment on thin revolved cutters + untrimmed-arc volume misreads ([#1501](https://github.com/esaueng/brepkit/issues/1501)) ([ca8c1ad](https://github.com/esaueng/brepkit/commit/ca8c1ad35e406e4510c20a889b63977afb2c360f))
* **operations:** give degenerate-locus points their predecessor's u in the CDT unwrap ([#1475](https://github.com/esaueng/brepkit/issues/1475)) ([52fbb88](https://github.com/esaueng/brepkit/commit/52fbb886f0c23967f742da34205074c00ef1c3e9))
* **operations:** harden periodic faces against split circle rims ([c82214c](https://github.com/esaueng/brepkit/commit/c82214c97c8dec56eb511a2b6dcb19b40c86d4ad))
* **operations:** keep blend convexity witnesses local ([1cebe8f](https://github.com/esaueng/brepkit/commit/1cebe8f260350c84cda4604be846d092e64f3e16))
* **operations:** make brepkit-io dev-dependency path-only ([e7b2af0](https://github.com/esaueng/brepkit/commit/e7b2af00f6e48487dd16546c594c70c8fb965aa4))
* **operations:** make the tessellation phase timer a wasm no-op ([#1506](https://github.com/esaueng/brepkit/issues/1506)) ([b04e0bf](https://github.com/esaueng/brepkit/commit/b04e0bfda9725b52fe81064fffe5263e83343d9c))
* **operations:** map pipe sampling into the path's domain ([#1483](https://github.com/esaueng/brepkit/issues/1483)) ([d0c746a](https://github.com/esaueng/brepkit/commit/d0c746ad65ac61f22574bd62281728c4a8883739))
* **operations:** orient CDT face meshes by an area-weighted normal vote ([#1469](https://github.com/esaueng/brepkit/issues/1469)) ([a2e029e](https://github.com/esaueng/brepkit/commit/a2e029e31e764f1c7f10572c9b96399226622585))
* **operations:** preserve valid periodic CDT unwrap ([b3d97ea](https://github.com/esaueng/brepkit/commit/b3d97eae44439b31ab6833dfcd497321454d2ee2))
* **operations:** prevent quadratic blowup in face connectivity construction ([588cc89](https://github.com/esaueng/brepkit/commit/588cc89515e3f43f06edfa9b7a2f418e60c01f28))
* **operations:** randomize boolean assembly hashing ([e5774e2](https://github.com/esaueng/brepkit/commit/e5774e21fb484f0aec91bfaeca6047475df4736f))
* **operations:** randomize boolean assembly hashing ([379f5af](https://github.com/esaueng/brepkit/commit/379f5af508658730e06e95338dfa713811f2861a))
* **operations:** recognize split rims in torus snap helpers ([6756785](https://github.com/esaueng/brepkit/commit/67567852a72df48987d33628e0dc97307610664d))
* **operations:** reject intersecting boolean components ([903ec55](https://github.com/esaueng/brepkit/commit/903ec55c47037c08fa4521740b2c88c7dcbf3d24))
* **operations:** reject intersecting shell components ([5ea7817](https://github.com/esaueng/brepkit/commit/5ea78173db5fc3e31e3c94ef539c37243051c06c))
* **operations:** reject intersecting shell components ([b92c5bd](https://github.com/esaueng/brepkit/commit/b92c5bdebcf6d9915d181771a4a9d728c07af714))
* **operations:** reject non-affine transforms atomically ([c80596f](https://github.com/esaueng/brepkit/commit/c80596f146f41cc1f8c3e179ac006f4ff636f584))
* **operations:** reject non-affine transforms atomically ([32e3855](https://github.com/esaueng/brepkit/commit/32e38556afe668bca3dfba8a7e873e674143089b))
* **operations:** reject non-finite band parameters ([b4b5b50](https://github.com/esaueng/brepkit/commit/b4b5b50891c7226140658936e492c67c0a8e2960))
* **operations:** reject non-finite band parameters ([2cd9888](https://github.com/esaueng/brepkit/commit/2cd9888667b0ea8095fdc3d283169043005b50d5))
* **operations:** restore the tolerant affine bottom-row check ([7f3e4dc](https://github.com/esaueng/brepkit/commit/7f3e4dcb593a04a872a2fb7bcbce6999300b2b77))
* **operations:** restore the tolerant affine bottom-row check ([03602a5](https://github.com/esaueng/brepkit/commit/03602a56405b1b40173bb0933e04d4447ceeb72e))
* **operations:** reverse concave coaxial corner walls in curve-preserving lofts ([#1404](https://github.com/esaueng/brepkit/issues/1404)) ([5a3e405](https://github.com/esaueng/brepkit/commit/5a3e40533622e3c910b515e6f52da777cbdf68af))
* **operations:** sweep pipes and option sweeps as positioned ([#1438](https://github.com/esaueng/brepkit/issues/1438)) ([621d4a8](https://github.com/esaueng/brepkit/commit/621d4a8129c73787d0f47821e9f45b131ccfc759))
* **operations:** sweep profiles as positioned instead of re-centering on the path ([#1421](https://github.com/esaueng/brepkit/issues/1421)) ([c9d9298](https://github.com/esaueng/brepkit/commit/c9d9298ca4bc3f51c91adac4a464ec655f6302e0))
* **operations:** tessellate split torus rim chains ([948afbf](https://github.com/esaueng/brepkit/commit/948afbfc4359c2746ab339dacc9a5778c2e7137e))
* **operations:** tolerate ulp-level noise in the affine bottom-row check ([c6cd9cf](https://github.com/esaueng/brepkit/commit/c6cd9cf7ee3ae843b08b63f44923fbfdb9cae65e))
* **operations:** validate evolution boolean semantics ([854aada](https://github.com/esaueng/brepkit/commit/854aadae69bc1820ac8857785b11853768e37799))
* **operations:** validate evolution boolean semantics ([0abdd48](https://github.com/esaueng/brepkit/commit/0abdd48437f3c65890dcccf6826dc4a185f78cf3))
...
* **operations:** validate partial revolve cap curves ([9b8b973](https://github.com/esaueng/brepkit/commit/9b8b9730c2eb9e5941c96f8a9f8c8bb877add8aa))
* **operations:** validate partial revolve cap curves ([e90de0a](https://github.com/esaueng/brepkit/commit/e90de0aa2b62f7bb3793309fd9331c47109676cd))
* **operations:** validate periodic rim cycles ([98b4fb0](https://github.com/esaueng/brepkit/commit/98b4fb0d36719081f8488d47aef83a5993050773))
* **operations:** verify spline geometry before normalization ([7f90645](https://github.com/esaueng/brepkit/commit/7f906450d20321b03e988cf27130bed3dc457c4b))
* **operations:** verify spline geometry before normalization ([0d41b30](https://github.com/esaueng/brepkit/commit/0d41b30c12f3fdbdbce1e82c404c41ad3abefc65))
...
* preserve fork fillet compatibility in upstream sync ([dfd45f2](https://github.com/esaueng/brepkit/commit/dfd45f21c1957d6ad6450fb0f4e86dd7ec90c6ae))
* **render:** reject oversized renders with a dedicated pixel-budget error ([0d2b357](https://github.com/esaueng/brepkit/commit/0d2b357fb639bdbcec0705f50f80d312e8ece86e))
* repair BrepKit 3.0.1 geometry regressions ([1a051db](https://github.com/esaueng/brepkit/commit/1a051db18960a442ecbc339a7aa4deb863b7d77d))
* repair BrepKit 3.0.1 geometry regressions ([0c0b889](https://github.com/esaueng/brepkit/commit/0c0b8893c9129b8ec4faad2462130c5cc8de517c))
* resolve imported Codex security findings ([9f900ba](https://github.com/esaueng/brepkit/commit/9f900ba5ac5c736e0fac5133ba88e26389090918))
* resolve imported security findings ([993f8be](https://github.com/esaueng/brepkit/commit/993f8be7327c6eb3c97c48458d068df39e8c0a83))
* **section:** avoid large-coordinate dedup collisions ([60c1bb4](https://github.com/esaueng/brepkit/commit/60c1bb4776ee3fe802924fd0807075e890149030))
* **section:** preserve large-coordinate section outlines ([9100925](https://github.com/esaueng/brepkit/commit/9100925c5f12dfebf80c5cdf83b02d22c217e8d7))
* **security:** bound NURBS trim sampling work ([c115478](https://github.com/esaueng/brepkit/commit/c115478891853bf2fcbbc01497614f971925b46e))
* **security:** make wire spur stripping linear ([0044f3e](https://github.com/esaueng/brepkit/commit/0044f3ee7b217e887f8e6399a300248173934022))
* **security:** make wire spur stripping linear ([ad2a542](https://github.com/esaueng/brepkit/commit/ad2a54248b1f444e53efb147a7d8b6fba8cc9f89))
* **sweep:** bound path densification output ([fd33f19](https://github.com/esaueng/brepkit/commit/fd33f19abf1310798ba1a84418ac15006d986f38))
* **sweep:** bound path densification output ([a4d23f3](https://github.com/esaueng/brepkit/commit/a4d23f33e72e5ed9b678339a28a894cb433d53f6))
* **topology:** deduplicate solid retirement traversal ([da14278](https://github.com/esaueng/brepkit/commit/da14278af657ce5ec7ec64afcbb4047fbcb3a55b))
* **topology:** deduplicate solid retirement traversal ([f857bf7](https://github.com/esaueng/brepkit/commit/f857bf7b9a4ce61256fb1f7a916cfcd1a17da852))
* **topology:** order edge_to_face_map so offset results stop varying per process ([#243](https://github.com/esaueng/brepkit/issues/243)) ([47e57da](https://github.com/esaueng/brepkit/commit/47e57dabe6c7933bd94e74d8c7f8a98585e14e66))
* **topology:** reject invalid ellipse arc endpoints ([9e299f5](https://github.com/esaueng/brepkit/commit/9e299f5eba12510c6f502eab61fe2437175bb586))
* **wasm:** do not gate checkpoint restore on lifetime slot count ([97b7466](https://github.com/esaueng/brepkit/commit/97b74666cc9cc18bb2f9c72beae0c8b2168c5974))
* **wasm:** do not gate checkpoint restore on lifetime slot count ([0406d64](https://github.com/esaueng/brepkit/commit/0406d649da37feb553b70dd8963783184ff1e29c))
* **wasm:** reject grouped mesh float overflow ([6d70cb4](https://github.com/esaueng/brepkit/commit/6d70cb45dd29125096d01500cdb8d1204aeeee85))


### Performance

* **algo:** clip sampled plane-analytic section chains to the face-pair overlap ([#1490](https://github.com/esaueng/brepkit/issues/1490)) ([c295975](https://github.com/esaueng/brepkit/commit/c2959752573233a95b20bf8efbc0ca57099acf51))
* **algo:** materialize deduped sections only when a duplicate exists ([#1454](https://github.com/esaueng/brepkit/issues/1454)) ([b94429e](https://github.com/esaueng/brepkit/commit/b94429e727c73f50e2d62e2c71ce3718ecb1cb3d))
* **blend:** O(E) sense lookup in orientation propagation ([#1468](https://github.com/esaueng/brepkit/issues/1468)) ([8c21365](https://github.com/esaueng/brepkit/commit/8c21365539dca93555d1c35321c1024f0d5633cb))
* **operations:** exact divergence-theorem volume for all-planar solids ([#1396](https://github.com/esaueng/brepkit/issues/1396)) ([1933079](https://github.com/esaueng/brepkit/commit/19330793a84219c662471f71a3466fb38e43d63a))
* **operations:** resolve BK_TESS_TRACE once per process ([#1471](https://github.com/esaueng/brepkit/issues/1471)) ([0d25f73](https://github.com/esaueng/brepkit/commit/0d25f73bd1946219fee5459c28927f0e14248123))
* **operations:** spatial-hash the circle T-junction splice in solid tessellation ([#1502](https://github.com/esaueng/brepkit/issues/1502)) ([b9f37f3](https://github.com/esaueng/brepkit/commit/b9f37f3958a5ff375ddd78053e2aee74ca901e14))
* **operations:** tolerance-driven display tessellation for developable faces ([#1478](https://github.com/esaueng/brepkit/issues/1478)) ([2ecfced](https://github.com/esaueng/brepkit/commit/2ecfced115c9a4c9c52e0d42c94d23d2523da5ed))
* **wasm:** skip the batch rollback snapshot for read-only ops ([271742b](https://github.com/esaueng/brepkit/commit/271742b025db2e314f86a8e40ec1d047379b39c8))
* **wasm:** skip the batch rollback snapshot for read-only ops ([0a9ad54](https://github.com/esaueng/brepkit/commit/0a9ad54a627d80b7452b378ba19d92d754b36750))
