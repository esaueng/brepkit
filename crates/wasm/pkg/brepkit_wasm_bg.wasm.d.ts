...
export const brepkernel_import3mf: (a: number, b: number, c: number) => [number, number, number, number];
export const brepkernel_importGlb: (a: number, b: number, c: number) => [number, number, number];
export const brepkernel_importIges: (a: number, b: number, c: number) => [number, number, number, number];
export const brepkernel_importIndexedMesh: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
export const brepkernel_importObj: (a: number, b: number, c: number) => [number, number, number];
export const brepkernel_importStep: (a: number, b: number, c: number) => [number, number, number, number];
export const brepkernel_importStl: (a: number, b: number, c: number) => [number, number, number];
