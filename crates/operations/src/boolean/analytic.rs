...
use super::assembly::{
    ...
    try_shared_boundary_fuse, validate_boolean_result, vertex_merge_resolution,
};
use super::classify::{
...
pub(super) fn face_count(topo: &Topology, solid: SolidId) -> Result<usize, crate::OperationsError> {
...
pub(super) fn mesh_boolean_path(
    topo: &mut Topology,
    op: BooleanOp,
    a: SolidId,
    b: SolidId,
    ...
    use super::assembly::assemble_solid_mixed;
    use super::types::FaceSpec;
