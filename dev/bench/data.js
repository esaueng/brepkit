    ...
    "Boolean perf": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e81fd6e8354159f62adf25bcbc5da495d64255e3",
          "message": "Fix OpenZCAD package publishing",
          "timestamp": "2026-07-19T00:48:16-04:00",
          "tree_id": "04e796f187dce848c4eb19d75b3448a36e08cdc3",
          "url": "https://github.com/esaueng/brepkit/commit/e81fd6e8354159f62adf25bcbc5da495d64255e3"
        },
        "date": 1784436635524,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "87ed5e5da7413bc1cb857f290ab3b1568604864a",
          "message": "Publish WASM package on main",
          "timestamp": "2026-07-19T01:19:47-04:00",
          "tree_id": "c48bfb3110a7a3d0b2a3a2ed5c892f56447be758",
          "url": "https://github.com/esaueng/brepkit/commit/87ed5e5da7413bc1cb857f290ab3b1568604864a"
        },
        "date": 1784438523376,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ff80688d08ae3f3859f07455e9a61e3a3488ae57",
          "message": "chore: sync upstream main",
          "timestamp": "2026-07-25T21:26:40-04:00",
          "tree_id": "54f21572e835931de58cdd4484ba9c87ff07cf9c",
          "url": "https://github.com/esaueng/brepkit/commit/ff80688d08ae3f3859f07455e9a61e3a3488ae57"
        },
        "date": 1785029390921,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f383a1eeaf866fe322e3853c44e998f07ffac43a",
          "message": "chore: format fuzz manifest",
          "timestamp": "2026-07-25T21:29:46-04:00",
          "tree_id": "adf8e087684bfc28e1ae9604b56fa85438075a4a",
          "url": "https://github.com/esaueng/brepkit/commit/f383a1eeaf866fe322e3853c44e998f07ffac43a"
        },
        "date": 1785029531202,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7f0d8b08d90bf827e6349f363fe8920b5bbc0584",
          "message": "feat(io): STEP import/export fidelity — surface curves, units, voids, swept surfaces (#37)\n\n* feat(io): resolve the SURFACE_CURVE family on STEP import\n\nOpenCascade wraps the 3-D geometry of essentially every edge on a curved\nface in SURFACE_CURVE (or its SEAM_CURVE / INTERSECTION_CURVE subtypes)\nso the pcurve representations can ride along. build_curve_geometry had no\narm for any of them and fell through to UnsupportedEntity, which is the\n\"unsupported STEP entity: SURFACE_CURVE (curve #397)\" refusal that stops\nOpenZCAD importing real-world STEP.\n\nResolve all three wrappers to their first attribute — the 3-D curve — and\nrecurse. The recursion carries a depth counter so a cyclic reference\nchain in a malformed file returns a typed ParseError instead of\noverflowing the stack and aborting the wasm module.\n\n* feat(io): honour the declared STEP units on import\n\nThe reader took every number in the file at face value, so an inch-authored\nor metre-authored STEP file imported 25.4x or 1000x wrong, silently. It\nalso read CONICAL_SURFACE semi-angles as radians regardless of the declared\nPLANE_ANGLE_UNIT, which is what forced OpenZCAD's STEP-text rewriter.\n\nResolve GLOBAL_UNIT_ASSIGNED_CONTEXT — standalone or as one component of the\nusual complex instance alongside GLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT — into\none length factor and one plane-angle factor, covering both SI_UNIT with any\nSI prefix and CONVERSION_BASED_UNIT chains (inch, degree). Apply the length\nfactor once at parse time to every length-valued quantity (CARTESIAN_POINT\ncoordinates and therefore B-spline control points and placements, circle and\nellipse radii, cylinder/cone/sphere/torus radii) and the angle factor to the\nconical semi-angle.\n\nbrepkit works in millimetres and radians: confirmed against the writer,\nwhich declares SI_UNIT(.MILLI.,.METRE.) and SI_UNIT($,.RADIAN.).\n\nA file whose length unit is missing, uninterpretable, or contradicted by a\nsecond context is refused with a typed ParseError. Guessing a length unit\nwould scale the entire model silently, which is the failure mode this\nproject exists to avoid.\n\n* feat(io): carry STEP solid voids through import and export\n\nMANIFOLD_SOLID_BREP only names an outer shell, so the reader hard-coded\nan empty inner-shell list and the writer emitted only the outer shell.\nA part with cavities therefore round-tripped as a filled part, with no\ndiagnostic at either end.\n\nReader: accept BREP_WITH_VOIDS (plain and complex-instance form) and\nbuild its trailing shells as the solid's inner shells. Resolve\nORIENTED_CLOSED_SHELL, propagating its .T./.F. flag as a face-sense flip\nthrough the shell so a reversed void shell comes back with the\norientation the file declared.\n\nWriter: emit BREP_WITH_VOIDS wrapping each inner shell in an\nORIENTED_CLOSED_SHELL(.F.), as ISO 10303-42 requires of void shells.\nSolids without cavities keep their MANIFOLD_SOLID_BREP form unchanged.\n\nTests cover a hollow cube (27 - 1 = 26) keeping both its volume and its\nsingle inner shell across a round trip, that a void-free solid still\nexports as MANIFOLD_SOLID_BREP, and that the ORIENTED_CLOSED_SHELL flag\ninverts every face sense in the shell.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* fix(io): require a STEP length unit only when there is geometry to scale\n\nResolving units unconditionally turned every file without a\nGLOBAL_UNIT_ASSIGNED_CONTEXT into a hard error, including well-formed\nproduct-structure-only and metadata-only files that carry no B-Rep at\nall. OpenZCAD ships one such fixture; before this it imported as zero\nsolids, after the units change it failed outright.\n\nSolid B-Reps are the only thing the reader builds and so the only\nconsumers of the length factor. Require the declaration exactly when one\nis present to build: a file with geometry and no usable LENGTH_UNIT is\nstill refused with a typed ParseError, while a file with nothing\nlength-valued resolves to no scale and imports as no solids.\n\nThe relaxation is deliberately narrow. A missing length factor is\nunobservable only when nothing reads it, so `resolve_unit_scale` returns\n`Option<UnitScale>` and the reader can never be handed a guessed factor.\nA declaration that is present but broken — unrecognised SI prefix, wrong\nSI base, conflicting contexts, cyclic conversion chain — is positive\nevidence of a malformed file and stays refused either way.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* test(io): pin AP214 and AP242 STEP schema tolerance on import\n\nThe reader never consulted FILE_SCHEMA, so AP214 and AP242 files already\nimported — but nothing recorded that as intentional, and a later change\nadding schema dispatch would have broken OpenZCAD, whose exporter writes\nAUTOMOTIVE_DESIGN rather than the AP203 brepkit emits.\n\nCover AP214 (plain, _CC2 and the object-identifier form), AP242 and the\nAP242 MIM_LF long form, asserting each imports to the same solid the\nAP203 original does, and that the writer still declares AP203. Document\nin the module header why schema-based dispatch is the wrong axis:\nall three protocols carry solids as the same ISO 10303-42 entities, so\nsupport is decided per entity, with anything unhandled failing as a typed\nUnsupportedEntity.\n\nNo validation is relaxed by this commit; it only records existing\nbehaviour.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* feat(io): read TRIMMED_CURVE and POLYLINE on STEP import\n\nBoth entities previously failed as UnsupportedEntity, so any file whose\nedges referenced them was rejected outright even though the geometry maps\ncleanly onto the existing EdgeCurve model.\n\nTRIMMED_CURVE resolves its basis curve through the same depth-bounded\npath as the SURFACE_CURVE family. How much of the trim has to survive\ndepends on the basis, because EdgeCurve stores no parameter range and an\nedge recovers its extent from its own vertices. For Line, Circle and\nEllipse that recovery is exact -- brepkit already models an arc as the\nwhole circle plus two vertices, which is how a bare CIRCLE in an\nEDGE_CURVE is read -- so the basis comes back unchanged. A B-spline is\nparameterized by its knots and endpoint projection is ambiguous on a\nclosed curve, so a .PARAMETER. trim is applied for real by splitting the\ncurve down to the declared span. Trims that fall outside the basis\ndomain, or that name an empty span, are refused with a typed error rather\nthan clamped.\n\nPOLYLINE becomes a degree-1 B-spline through its points, chord-length\nknotted so the parameter tracks arc length and endpoint projection stays\nwell conditioned. A two-point polyline is just a segment and reads as\nEdgeCurve::Line. Coincident consecutive points would need an interior\nknot of multiplicity 2, which degree 1 cannot carry, so they are dropped;\na polyline that collapses to a single point has no geometry and is\nrefused.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* feat(io): resolve SURFACE_OF_REVOLUTION and SURFACE_OF_LINEAR_EXTRUSION\n\nBoth swept surface types failed as UnsupportedEntity, so files that state\na cylinder, cone, sphere or torus as a sweep -- which many exporters do --\nwere rejected even though brepkit models every one of those exactly.\n\nCollapse to the analytic surface first, because an exact analytic surface\nis worth far more downstream than a NURBS approximation of the same\nshape. Revolving a line parallel to the axis gives a cylinder, one\nmeeting it at an angle a cone, one meeting it at a right angle a plane;\nrevolving a circle whose plane holds the axis gives a sphere when it is\ncentred on the axis and a torus when it is offset. Extruding a circle\nalong its own normal gives a cylinder and a line off its own direction a\nplane.\n\nEverything else with a bounded profile becomes an exact NURBS surface,\nnot a sampled one: conics convert to the nine-point rational quadratic,\nextrusion is the tensor product with a degree-1 line, and revolution\nfollows Piegl & Tiller A8.1, whose per-control-point rings are that same\nrational quadratic. Tests check the constructions against the implicit\ntorus and cone equations rather than against themselves.\n\nWhat is left has no representation at all rather than a lossy one: a line\nskew to the axis sweeps a hyperboloid, and being unbounded it cannot\nbecome a NURBS patch either. That is refused as a typed UnsupportedEntity\nnaming the entity and the reason. Degenerate sweeps -- a profile lying on\nits own axis of revolution, a line extruded along itself, a zero-length\nextrusion -- are refused as typed parse errors.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* refactor(io): keep swept-profile conversion failures distinct from unbounded ones\n\n`SweptProfile::into_nurbs` collapsed a conic construction error into the\nsame `None` that means \"this profile is a line and has no NURBS form\", so\na construction failure would have been reported as an unrepresentable\nhyperboloid. Return `Result<Option<_>>` so the caller reports the reason\nthat actually applies.\n\nAlso correct the SWEEP_DIR_EPS comment: the constant bounds a sine or\ncosine of unit vectors directly, so it is 1e-9 radians, not 6e-8.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* docs(io): record the STEP reader's unit policy in the module header\n\nThe refusal to guess a length unit is a behaviour consumers need to plan\nfor, so state it where the schema-tolerance note already is rather than\nonly on the private function that implements it.\n\nCo-Authored-By: Claude Fable 5 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_015ERHr2EBswj2UpGki3pvZy\n\n* fix(io): write and read CONICAL_SURFACE at ISO 10303-42's angle\n\nISO 10303-42 states a cone's `semi_angle` as the half-angle at the apex\nmeasured from the AXIS. brepkit's `ConicalSurface::half_angle` is measured\nfrom the RADIAL PLANE. The STEP layer passed one straight through as the\nother in both directions, so the two conventions cancelled on our own files\nand round-tripped perfectly — while every cone we exported was read at its\ncomplement by any other CAD system, and every foreign cone we imported came\nin at the wrong angle. The two agree only at 45 degrees, which is why\nnothing caught it.\n\n`make_cone(r=1, h=2)` exported `semi_angle` 1.107 rad (63.43 degrees, the\nangle from the radial plane) where ISO calls for atan(1/2) = 26.57 degrees.\n\nConvert on both sides. The new tests assert against angles derived from the\ncone's own dimensions rather than from what the code emits, so reverting\neither side fails them, and one explicitly rejects the complement.\n\nThis changes the on-disk meaning of cones in files brepkit wrote before it.\nThose files were already non-conforming — every other reader has always\ninterpreted them the way brepkit now will, so this aligns us with the rest\nof the world rather than departing from it.\n\n* docs(io): stop the reader module header linking a private item\n\n`cargo doc -D warnings` rejects an intra-doc link from public documentation\nto a private function, so the module header's pointer at\n`resolve_unit_scale` failed the Documentation job. State the unit policy\ninline instead, including the case the link was there to explain: a file\nwith nothing length-valued still imports, as zero solids.\n\n---------\n\nCo-authored-by: Claude <noreply@anthropic.com>",
          "timestamp": "2026-08-01T01:17:45-05:00",
          "tree_id": "e1cc468204e20c450997eb2ec62243059633499e",
          "url": "https://github.com/esaueng/brepkit/commit/7f0d8b08d90bf827e6349f363fe8920b5bbc0584"
        },
        "date": 1785565242460,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "36ea0e138ff290d1c3c2933346b1d5627395007a",
          "message": "Merge pull request #68 from esaueng/claude/fork-sync-pr-jwy9t3\n\nSync fork with upstream andymai/brepkit: multi-region booleans, 2D interior sampling, fillet guard",
          "timestamp": "2026-08-02T14:01:24-05:00",
          "tree_id": "05259f94b50904b1a72083ad4ea20cef5973581d",
          "url": "https://github.com/esaueng/brepkit/commit/36ea0e138ff290d1c3c2933346b1d5627395007a"
        },
        "date": 1785697437952,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "890e35c76ccba5bcbf56537163ce0a062a5b117a",
          "message": "Merge pull request #73 from esaueng/security/audit-prevention\n\nci: secrets scanning + credential gitignore (audit follow-up)",
          "timestamp": "2026-08-03T21:38:32-05:00",
          "tree_id": "d1e5c10a93b658a860e833db028f6f45cddb0bf8",
          "url": "https://github.com/esaueng/brepkit/commit/890e35c76ccba5bcbf56537163ce0a062a5b117a"
        },
        "date": 1785811453751,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "304e455ad5fc20e50ee9b7a399af3c8cdb6bb6b6",
          "message": "Merge pull request #81 from esaueng/codex/fix-gitleaks-installer\n\nci: install gitleaks from verified release",
          "timestamp": "2026-08-03T23:09:15-05:00",
          "tree_id": "ff36a424382a0900b838f9e3ac836d73018d95ad",
          "url": "https://github.com/esaueng/brepkit/commit/304e455ad5fc20e50ee9b7a399af3c8cdb6bb6b6"
        },
        "date": 1785816696525,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "083ce513e37f7a0bd28f6a9223256bd42b8f1037",
          "message": "Merge pull request #83 from esaueng/codex/sync-upstream-2026-08-04\n\nSync selected upstream geometry fixes through #1284",
          "timestamp": "2026-08-04T01:11:08-05:00",
          "tree_id": "92918d2716ed44f82d05064f566a099aa5dfe1ca",
          "url": "https://github.com/esaueng/brepkit/commit/083ce513e37f7a0bd28f6a9223256bd42b8f1037"
        },
        "date": 1785824010342,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6890ccb2da64319c24b9ef6e90265f5e0bda7d8e",
          "message": "Merge pull request #100 from esaueng/codex/sync-upstream-2026-08-07\n\nchore: sync upstream main through 2dc9b94c",
          "timestamp": "2026-08-07T00:52:18-05:00",
          "tree_id": "84bee98927d0338c9fa0450397dccaca4c6b6977",
          "url": "https://github.com/esaueng/brepkit/commit/6890ccb2da64319c24b9ef6e90265f5e0bda7d8e"
        },
        "date": 1786082055894,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "dbb033f3c5ed7dccfafecf96cba1525df921924d",
          "message": "Merge pull request #113 from esaueng/fix/corner-tangent-line-graze\n\nfix(algo): veto line sections that only graze a plane face's rim",
          "timestamp": "2026-08-07T11:48:20-05:00",
          "tree_id": "cc277ba3aeb0dfebccf4b05d2cbb36ab71e19ee7",
          "url": "https://github.com/esaueng/brepkit/commit/dbb033f3c5ed7dccfafecf96cba1525df921924d"
        },
        "date": 1786121469676,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ee6e6d8691d069a9f24f579272e0fc3aad80dd17",
          "message": "chore(wasm): bump kernel to 3.0.1 (#118)\n\nCo-authored-by: Peter <171875562+petergstfsn@users.noreply.github.com>",
          "timestamp": "2026-08-07T23:58:51-04:00",
          "tree_id": "5d21e32a2a3124dc63e88b0a321ab2660198c77c",
          "url": "https://github.com/esaueng/brepkit/commit/ee6e6d8691d069a9f24f579272e0fc3aad80dd17"
        },
        "date": 1786161648209,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1a051db18960a442ecbc339a7aa4deb863b7d77d",
          "message": "Merge pull request #123 from esaueng/codex/repair-brepkit-3-0-1\n\nfix: repair BrepKit 3.0.1 geometry regressions",
          "timestamp": "2026-08-10T00:33:34-04:00",
          "tree_id": "bb3177b122f6a96361b098d9df1784fa7efbdd60",
          "url": "https://github.com/esaueng/brepkit/commit/1a051db18960a442ecbc339a7aa4deb863b7d77d"
        },
        "date": 1786336531993,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "715ea89bec3a8695f1d9313baea681077a322986",
          "message": "Merge pull request #135 from esaueng/codex/rewrite-agent-instructions\n\ndocs: rewrite agent instructions from verified repository state",
          "timestamp": "2026-08-11T20:20:53-04:00",
          "tree_id": "06c404aec2ded76924e451b235a4ab24e7ff96bc",
          "url": "https://github.com/esaueng/brepkit/commit/715ea89bec3a8695f1d9313baea681077a322986"
        },
        "date": 1786494162852,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fd33f19abf1310798ba1a84418ac15006d986f38",
          "message": "Merge pull request #151 from esaueng/codex/fix-unbounded-densification-in-sweep-path\n\nfix(sweep): bound path densification output",
          "timestamp": "2026-08-12T12:10:37-04:00",
          "tree_id": "5efc0f99e955a6a8b6b1abeb8e48d1ca943ee765",
          "url": "https://github.com/esaueng/brepkit/commit/fd33f19abf1310798ba1a84418ac15006d986f38"
        },
        "date": 1786551257222,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "255633af052784c9ffbde9e733711a7d4f560eac",
          "message": "Merge pull request #169 from esaueng/codex/fix-wasm-ply-import-vulnerability\n\nfix(io): reject zero-vertex ASCII PLY faces",
          "timestamp": "2026-08-12T12:49:40-04:00",
          "tree_id": "ae0b06337ae1d98c9c1b272326a3f54b32743f50",
          "url": "https://github.com/esaueng/brepkit/commit/255633af052784c9ffbde9e733711a7d4f560eac"
        },
        "date": 1786553559381,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0de0ee4d96fbe5864bec9f7bfb03433b2905bf55",
          "message": "Merge pull request #183 from esaueng/codex/propose-fix-for-nurbs-aabb-vulnerability\n\nfix(boolean): reject sampled NURBS disjoint proofs",
          "timestamp": "2026-08-12T13:25:36-04:00",
          "tree_id": "403a0908cc7a2fa046526674c160159739bcd144",
          "url": "https://github.com/esaueng/brepkit/commit/0de0ee4d96fbe5864bec9f7bfb03433b2905bf55"
        },
        "date": 1786555667382,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "580075d80a0b74c1c690777bd4ad51109c6a02fe",
          "message": "Merge pull request #192 from esaueng/codex/propose-fix-for-nurbs-boundary-dos-vulnerability\n\nfix(algo): hoist trimmed NURBS domain projection out of arc bisection loop",
          "timestamp": "2026-08-12T13:41:08-04:00",
          "tree_id": "354df0c9bd5eba3f52ec230077846d630a6d5695",
          "url": "https://github.com/esaueng/brepkit/commit/580075d80a0b74c1c690777bd4ad51109c6a02fe"
        },
        "date": 1786556621327,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "588cc89515e3f43f06edfa9b7a2f418e60c01f28",
          "message": "Merge pull request #198 from esaueng/codex/fix-quadratic-validation-dos-vulnerability\n\nfix(operations): prevent quadratic blowup in face connectivity construction",
          "timestamp": "2026-08-12T13:48:38-04:00",
          "tree_id": "392663e88e1e82fe6e376797c75e53007de6c243",
          "url": "https://github.com/esaueng/brepkit/commit/588cc89515e3f43f06edfa9b7a2f418e60c01f28"
        },
        "date": 1786557154661,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ebc590ea40b9c17136abef28f263614f5591205d",
          "message": "Merge pull request #200 from esaueng/codex/propose-fix-for-quadratic-validation-dos\n\nfix(operations): bound component overlap validation",
          "timestamp": "2026-08-12T13:51:38-04:00",
          "tree_id": "4522f3e2af3d0f5e92b0900fa6bb267066ab3715",
          "url": "https://github.com/esaueng/brepkit/commit/ebc590ea40b9c17136abef28f263614f5591205d"
        },
        "date": 1786557289409,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "cbd5d8b6d85fffddf9c8c2430a2dd09d35434755",
          "message": "Merge pull request #202 from esaueng/codex/fix-nurbs-bounding-box-vulnerability\n\nBound NURBS trim sampling to prevent quadratic CPU DoS",
          "timestamp": "2026-08-12T14:31:57-04:00",
          "tree_id": "3cf0cd6f70b90d3215cd9b5414bb727132b49d63",
          "url": "https://github.com/esaueng/brepkit/commit/cbd5d8b6d85fffddf9c8c2430a2dd09d35434755"
        },
        "date": 1786559678280,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f3591af3330e1a91268ca11716ba17dea842a1ce",
          "message": "Merge pull request #210 from esaueng/codex/fix-unsafe-ci-artifact-extraction\n\nfix(ci): validate committed WASM artifact",
          "timestamp": "2026-08-12T14:54:10-04:00",
          "tree_id": "853d5c013bd3f10e6ac77b2befe440aa838d3988",
          "url": "https://github.com/esaueng/brepkit/commit/f3591af3330e1a91268ca11716ba17dea842a1ce"
        },
        "date": 1786560999071,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7751ffa93a3e712972562db355a1f1b85459a8b4",
          "message": "Merge pull request #164 from esaueng/codex/propose-fix-for-nurbs-boundary-vulnerability\n\nfix(algo): scope split registry anchors by pave block",
          "timestamp": "2026-08-12T16:24:24-04:00",
          "tree_id": "0bd0608f778a77bc1ec97f91fd998b18b1feb260",
          "url": "https://github.com/esaueng/brepkit/commit/7751ffa93a3e712972562db355a1f1b85459a8b4"
        },
        "date": 1786566399233,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c56eb8102dd0248b17073f7e47e53e6244efb851",
          "message": "Merge pull request #220 from esaueng/codex/fix-panic-inducing-nurbs-domain-validation\n\nfix(math): reject reversed NURBS domains",
          "timestamp": "2026-08-12T22:13:58-04:00",
          "tree_id": "afcabebc21cf014747b23fbcfc27b553712e4363",
          "url": "https://github.com/esaueng/brepkit/commit/c56eb8102dd0248b17073f7e47e53e6244efb851"
        },
        "date": 1786587362840,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "9100925c5f12dfebf80c5cdf83b02d22c217e8d7",
          "message": "Merge pull request #227 from esaueng/codex/fix-section-deduplication-issue\n\nfix(section): preserve large-coordinate section outlines",
          "timestamp": "2026-08-14T08:21:25-04:00",
          "tree_id": "3dd365f93bb0c9ae91b4d44883279ddde6b8d24e",
          "url": "https://github.com/esaueng/brepkit/commit/9100925c5f12dfebf80c5cdf83b02d22c217e8d7"
        },
        "date": 1786710392461,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e142b5727f56188014ebec723b81e8104063fd1d",
          "message": "fix: replay Apache-compatible security hardening (#252)",
          "timestamp": "2026-08-14T22:43:21-04:00",
          "tree_id": "4c4650e0aa43cc3443c8d6eddcf53b5031198d13",
          "url": "https://github.com/esaueng/brepkit/commit/e142b5727f56188014ebec723b81e8104063fd1d"
        },
        "date": 1786761913004,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "68d5085100c27588165a714c650cbc0a1e1f929d",
          ...
          "url": "https://github.com/esaueng/brepkit/commit/68d5085100c27588165a714c650cbc0a1e1f929d"
        },
        "date": 1786763593853,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "69bf53a1584c76ccdc796d22283624bb0be8568c",
          "message": "feat: replay Apache-compatible fork contributions (#253)\n\n* audit: replay PR #166\n\n* audit: replay PR #168\n\n* audit: replay PR #169\n\n* audit: replay PR #170\n\n* audit: replay PR #171\n\n* audit: replay PR #173\n\n* audit: replay PR #177\n\n* audit: replay PR #178\n\n* audit: replay PR #179\n\n* audit: replay PR #180\n\n* audit: replay PR #181\n\n* audit: replay PR #183\n\n* audit: replay PR #184\n\n* audit: replay PR #175\n\n* audit: replay PR #186\n\n* audit: replay PR #187\n\n* audit: replay PR #188\n\n* audit: replay PR #189\n\n* audit: replay PR #190\n\n* audit: replay PR #192\n\n* audit: replay PR #193\n\n* audit: replay PR #194\n\n* audit: replay PR #195\n\n* audit: replay PR #198\n\n* audit: replay PR #200\n\n* audit: replay PR #201\n\n* audit: replay PR #204\n\n* audit: replay PR #202\n\n* audit: replay PR #203\n\n* audit: replay PR #209\n\n* audit: replay PR #212\n\n* audit: replay PR #215\n\n* audit: replay PR #149\n\n* audit: replay PR #164\n\n* audit: replay PR #165\n\n* audit: replay PR #167\n\n* audit: replay PR #182\n\n* audit: replay PR #216\n\n* audit: replay PR #220\n\n* audit: replay PR #225\n\n* audit: replay PR #226\n\n* audit: replay PR #227\n\n* audit: replay PR #228\n\n* audit: replay PR #245\n\n* audit: port core of PR #243\n\n* audit: adapt tessellation to ordered edge map\n\n* audit: manually port PR #191\n\n* audit: manually port PR #211\n\n* audit: manually port PR #145\n\n* audit: manually port PR #172\n\n* audit: replay PR #218\n\n* audit: port clean PR #229 source subset\n\n* audit: port remaining PR #229 source fixes\n\n* audit: refresh lockfile for PR #218\n\n* audit: adapt PR #230 to Apache versions\n\n* audit: adapt PR #221 Apache package consumer\n\n* audit: adapt PR #223 exact blend editing foundations\n\n* audit: replay PR #233 checkpoint restore lifetime fix\n\n* audit: replay PR #234 fillet selection limits\n\n* audit: replay PR #235 affine tolerance fix\n\n* audit: adapt PR #240 same-domain overlap pairing\n\n* audit: adapt PR #241 boolean flatten recursion guard\n\n* audit: adapt PR #242 lazy batch rollback snapshots\n\n* audit: replay PR #239 closed ellipse same-domain keys\n\n* audit: adapt PR #238 pre-snapshot batch classification\n\n* audit: replay PR #236 bounded section edge matching\n\n* audit: replay PR #237 bounded feature recognition\n\n* audit: replay PR #244 affine inverse conditioning\n\n* audit: replay PR #247 batch deflection validation\n\n* audit: retain PR #224 rim angle regressions\n\n* audit: adapt PR #222 to Apache staging runners\n\n* audit: adapt PRs #185 and #210 to Apache package refresh\n\n* fix(ci): keep generated WASM tied to its source commit\n\n* audit: record Apache replay provenance\n\nSigned-off-by: Peter <171875562+petergstfsn@users.noreply.github.com>\n\n* audit: complete post-cutoff contribution accounting\n\nSigned-off-by: Peter <171875562+petergstfsn@users.noreply.github.com>\n\n* audit: pin real Apache replay provenance\n\n* chore(wasm): refresh Apache replay package\n\n* fix(build): break unpublished dev dependency cycle\n\n---------\n\nSigned-off-by: Peter <171875562+petergstfsn@users.noreply.github.com>\nCo-authored-by: Peter <171875562+petergstfsn@users.noreply.github.com>",
          "timestamp": "2026-08-14T23:35:05-04:00",
          "tree_id": "92bcaaf21085d6f083ace59c3316c3620f7cf2e9",
          "url": "https://github.com/esaueng/brepkit/commit/69bf53a1584c76ccdc796d22283624bb0be8568c"
        },
        "date": 1786773663516,
        "tool": "cargo",
        "benches": [
